System.register("treemap", [], function(exports_1, context_1) {
    "use strict";
    ...
    exports_1("newOptions", newOptions);
    function newCaptionOptions() {
        var options = newOptions();
        var createNode = options.createNode;
        options.getPadding = function () { return [14, 0, 0, 0]; };
        options.createNode = function (data) {
    ...
    exports_1("newCaptionOptions", newCaptionOptions);
    /**
        ...
        execute: function() {
            TreeMap = (function () {
                function TreeMap(data, options) {
                    if (options === void 0) { options = newOptions(); }
                    this.data = data;
                 ...
                 */
                TreeMap.prototype.selectSpan = function (children, space, start) {
                    ...
                    var smin = children[start].size; // Smallest seen child so far.
                    var smax = smin; // Largest child.
                    var sum = 0; // Sum of children in this span.
                    var lastScore = 0; // Best score yet found.
                    var end = start;
                    for (; end < children.length; end++) {
                        var size = children[end].size;
                        if (size < smin)
                            smin = size;
                        if (size > smax)
                            smax = size;
                    ...
                    return { end: end, sum: sum };
                };
                TreeMap.prototype.layout = function (container, data, width, height) {
                    var total = data.size;
                    var children = data.children;
                    if (!children)
                        return;
                    var x1 = 0, y1 = 0, x2 = width, y2 = height;
                    var spacing = this.options.getSpacing();
                    var padding = this.options.getPadding();
                    y1 += padding[0];
                    x2 -= padding[1];
                    y2 -= padding[2];
                    x1 += padding[3];
                    ...
                    if ((y2 - y1) < 100)
                        return;
                    var scale = Math.sqrt(total / ((x2 - x1) * (y2 - y1)));
                    function px(x) {
                    ...
                    for (var start = 0; start < children.length;) {
                        x = x1;
                        var space = scale * (x2 - x1);
                        var _a = this.selectSpan(children, space, start), end = _a.end, sum = _a.sum;
                        if (sum / total < 0.1)
                            break;
                        var height_1 = sum / space;
                        var heightPx = height_1 / scale;
                        for (var i = start; i < end; i++) {
                            var size = children[i].size;
                            var width_1 = size / height_1;
                            var widthPx = width_1 / scale;
                            var dom = this.options.createNode(children[i]);
                            dom.style.left = px(x);
                ...
                TreeMap.prototype.render = function (container) {
                    var dom = this.options.createNode(this.data);
                ...
                TreeMap.prototype.getAddress = function (node) {
                    var indexes = [];
            ...
            exports_1("TreeMap", TreeMap);
        }
    }
});
System.register("demo-data", [], function(exports_2, context_2) {
    "use strict";
            ...
            exports_2("default",{
                ...
                "children": [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "children": [
                                                            ...
                                                            { "size": 186, "caption": "TextCodec.cpp 186" },
                                                            {
                                                                ...
                                                                "children": [{
                                                                        "size": 158,
                                                                        "caption": "TextBreakIteratorInternalICUChromium.cpp 158"
                                                                    }]
                                                            },
                                            ...
                                            },
                                            {
                                                ...
                                                "children": [
                                                    ...
                                                    { "size": 265, "caption": "InsertNodeBeforeCommand.cpp 265" },
                                                    {
                                                        ...
                                                        "children": [{ "size": 257, "caption": "EditorChromium.cpp 257" }]
                                                    },
                                                    {
                                                        "size": 252,
                                                        ...
                                                        "children": [
                                                            {
                                                                ...
                                                                "children": [
                                                                    ...
                                                                    {
                                                                        "size": 8391,
                                                                        "caption": "V8WebGLRenderingContextCustom.cpp 8.4k"
                                                                    },
                                                                    {
                                                                        "size": 6068,
                                                                    ...
                                                                    {
                                                                        "size": 1672,
                                                                        "caption": "V8InspectorFrontendHostCustom.cpp 1.7k"
                                                                    },
                                                                    {
                                                                        "size": 1668,
                                                                    ...
                                                                    {
                                                                        "size": 1342,
                                                                        "caption": "V8HTMLOptionElementConstructor.cpp 1.3k"
                                                                    },
                                                                    {
                                                                        "size": 1328,
                                                                    ...
                                                                    {
                                                                        "size": 1082,
                                                                        "caption": "V8DeviceOrientationEventCustom.cpp 1.1k"
                                                                    },
                                                                    {
                                                                        "size": 991,
                                                                    ...
                                                                    {
                                                                        "size": 789,
                                                                        "caption": "V8CanvasRenderingContext2DCustom.cpp 789"
                                                                    },
                                                                    {
                                                                        "size": 780,
                                                                    ...
                                                                    {
                                                                        "size": 490,
                                                                        "caption": "V8DedicatedWorkerContextCustom.cpp 490"
                                                                    },
                                                                    {
                                                                        "size": 469,
                                                                    ...
                                                                    {
                                                                        "size": 331,
                                                                        "caption": "V8CustomSQLStatementErrorCallback.cpp 331"
                                                                    },
                                                                    {
                                                                        "size": 318,
                                        ...
                                        "children": [{
                                                ...
                                                "children": [
                                                    ...
                                                    },
                                                    {
                                                        "size": 73,
                                                        "caption": "public 73",
                                                        "children": [{ "size": 73, "caption": "WebString.h 73" }]
                                                    }
                                                ]
                                            }]
                                    },
                            ...
                            },
                            {
                                ...
                                "children": [
                                    ...
                                    },
                                    {
                                        "size": 5847,
                                        "caption": "google 5.8k",
                                        "children": [{ "size": 5847, "caption": "bdict_reader.cc 5.8k" }]
                                    }
                                ]
                            },
                            {
                        ...
                        "children": [
                            {
                                ...
                                "children": [
                                        ...
                                        "children": [
                                            ...
                                            },
                                            {
                                                ...
                                                "children": [
                                                    ...
                                                    {
                                                        "size": 17357,
                                                        "caption": "build_and_process_conflict_sets_command.cc 17.4k"
                                                    },
                                    ...
                                    },
                                    {
                                        ...
                                        "children": [
                                            ...
                                            },
                                            {
                                                "size": 6594,
                                                "caption": "gaia 6.6k",
                                                "children": [{ "size": 6594, "caption": "token_service.cc 6.6k" }]
                                            },
                                    ...
                                    },
                                    {
                                        ...
                                        "children": [
                                            ...
                                            { "size": 2954, "caption": "template_url_fetcher.cc 3.0k" }, {
                                                "size": 1664,
                                                "caption": "search_provider_install_state_dispatcher_host.cc 1.7k"
                                            },
                                            {
                                                "size": 1154,
                                    ...
                                    { "size": 3452, "caption": "profile_manager.cc 3.5k" },
                                    {
                                        ...
                                        "children": [{ "size": 3451, "caption": "nacl_process_host.cc 3.5k" }]
                                    },
                            ...
                            },
                            {
                                ...
                                "children": [
                                    ...
                                    { "size": 228, "caption": "native_web_keyboard_event_linux.cc 228" },
                                    {
                                        ...
                                        "children": [{ "size": 227, "caption": "web_resource_unpacker.cc 227" }]
                                    },
                                ...
                                "children": [
                                    {
                                        ...
                                        "children": [{
                                                ...
                                                "children": [
                                                        ...
                                                        "children": [
                                                            {
                                                                ...
                                                                "children": [
                                                                    ...
                                                                    {
                                                                        "size": 1935,
                                                                        "caption": "V8SVGComponentTransferFunctionElement.cpp 1.9k"
                                                                    },
                                                                    {
                                                                        "size": 1933,
                                                                    ...
                                                                    {
                                                                        "size": 1896,
                                                                        "caption": "V8HTMLScriptElement.cpp 1.9k"
                                                                    },
                                                                    {
                                                                        "size": 1881,
                                                                        "caption": "V8SVGPathSegArcAbs.cpp 1.9k"
                                                                    },
                                                                    { "size": 1876, "caption": "V8Clipboard.cpp 1.9k" },
                                                                    { "size": 1864, "caption": "V8ErrorEvent.cpp 1.9k" },
                                                                    {
                                                                        "size": 1860,
                                                                        "caption": "V8HTMLMeterElement.cpp 1.9k"
                                                                    },
                                                                    { "size": 1858, "caption": "V8SVGDescElement.cpp 1.9k" },
                                                                    { "size": 1858, "caption": "V8SVGTitleElement.cpp 1.9k" },
                                                                    {
                                                                        "size": 1855,
                                                                        "caption": "V8HTMLAppletElement.cpp 1.9k"
                                                                    },
                                                                    {
                                                                        "size": 1842,
                                                                        "caption": "V8SVGPathSegArcRel.cpp 1.8k"
                                                                    },
                                                                    { "size": 1817, "caption": "V8Text.cpp 1.8k" },
                                                                    { "size": 1798, "caption": "V8TextEvent.cpp 1.8k" },
                                                                    {
                                                                        "size": 1798,
                                                                        "caption": "V8CompositionEvent.cpp 1.8k"
                                                                    },
                                                                    { "size": 1796, "caption": "V8SVGRect.cpp 1.8k" },
                                                                    {
                                                                        "size": 1794,
                                                                        "caption": "V8HTMLTableSectionElement.cpp 1.8k"
                                                                    },
                                                                    { "size": 1785, "caption": "V8Worker.cpp 1.8k" },
                                                                    { "size": 1759, "caption": "V8HTMLLinkElement.cpp 1.8k" },
                                                                    {
                                                                        "size": 1753,
                                                                        "caption": "V8DocumentFragment.cpp 1.8k"
                                                                    },
                                                                    {
                                                                        "size": 1708,
                                                                        "caption": "V8SVGPathSegCurvetoCubicRel.cpp 1.7k"
                                                                    },
                                                                    {
                                                                        "size": 1708,
                                                                        "caption": "V8SVGPathSegCurvetoCubicAbs.cpp 1.7k"
                                                                    },
                                                                    {
                                                                        "size": 1704,
                                                                        "caption": "V8HTMLEmbedElement.cpp 1.7k"
                                                                    },
                                                                    { "size": 1680, "caption": "V8NodeIterator.cpp 1.7k" },
                                                                    { "size": 1679, "caption": "V8CSSMediaRule.cpp 1.7k" },
                                                                    {
                                                                        "size": 1676,
                                                                        "caption": "V8InjectedScriptHost.cpp 1.7k"
                                                                    },
                                                                    { "size": 1669, "caption": "V8Blob.cpp 1.7k" },
                                                                    {
                                                                        "size": 1668,
                                                                        "caption": "V8DedicatedWorkerContext.cpp 1.7k"
                                                                    },
                                                                    {
                                                                        "size": 1659,
                                                                        "caption": "V8SVGGradientElement.cpp 1.7k"
                                                                    },
                                                                    { "size": 1650, "caption": "V8SVGPoint.cpp 1.6k" },
                                                                    {
                                                                        "size": 1609,
                                                                        "caption": "V8SVGTextPositioningElement.cpp 1.6k"
                                                                    },
                                                                    {
                                                                        "size": 1592,
                                                                        "caption": "V8HTMLSourceElement.cpp 1.6k"
                                                                    },
                                                                    { "size": 1578, "caption": "V8DOMPluginArray.cpp 1.6k" },
                                                                    { "size": 1563, "caption": "V8BeforeLoadEvent.cpp 1.6k" },
                                                                    {
                                                                        "size": 1558,
                                                                        "caption": "V8HTMLFieldSetElement.cpp 1.6k"
                                                                    },
                                                                    {
                                                                        "size": 1548,
                                                                        "caption": "V8WebKitTransitionEvent.cpp 1.5k"
                                                                    },
                                                                    {
                                                                        "size": 1548,
                                                                        "caption": "V8WebKitAnimationEvent.cpp 1.5k"
                                                                    },
                                                                    { "size": 1545, "caption": "V8ProgressEvent.cpp 1.5k" },
                                                                    { "size": 1535, "caption": "V8DOMStringList.cpp 1.5k" },
                                                                    { "size": 1510, "caption": "V8SVGStopElement.cpp 1.5k" },
                                                                    {
                                                                        "size": 1499,
                                                                        "caption": "V8SVGRadialGradientElement.cpp 1.5k"
                                                                    },
                                                                    { "size": 1469, "caption": "V8XPathException.cpp 1.5k" },
                                                                    {
                                                                        "size": 1469,
                                                                        "caption": "V8DOMCoreException.cpp 1.5k"
                                                                    },
                                                                    { "size": 1469, "caption": "V8RangeException.cpp 1.5k" },
                                                                    { "size": 1469, "caption": "V8SVGException.cpp 1.5k" },
                                                                    {
                                                                        "size": 1469,
                                                                        "caption": "V8XMLHttpRequestException.cpp 1.5k"
                                                                    },
                                                                    { "size": 1469, "caption": "V8EventException.cpp 1.5k" },
                                                                    { "size": 1465, "caption": "V8SVGViewElement.cpp 1.5k" },
                                                                    {
                                                                        "size": 1463,
                                                                        "caption": "V8SVGAltGlyphElement.cpp 1.5k"
                                                                    },
                                                                    {
                                                                        "size": 1463,
                                                                        "caption": "V8SharedWorkerContext.cpp 1.5k"
                                                                    },
                                                                    { "size": 1455, "caption": "V8Attr.cpp 1.5k" },
                                                                    { "size": 1451, "caption": "V8IDBFactory.cpp 1.5k" },
                                                                    { "size": 1436, "caption": "V8XPathExpression.cpp 1.4k" },
                                                                    { "size": 1416, "caption": "V8CustomEvent.cpp 1.4k" },
                                                                    {
                                                                        "size": 1409,
                                                                        "caption": "V8SVGTextPathElement.cpp 1.4k"
                                                                    },
                                                                    {
                                                                        "size": 1405,
                                                                        "caption": "V8DOMMimeTypeArray.cpp 1.4k"
                                                                    },
                                                                    { "size": 1393, "caption": "V8WorkerNavigator.cpp 1.4k" },
                                                                    {
                                                                        "size": 1358,
                                                                        "caption": "V8SVGPathSegCurvetoCubicSmoothRel.cpp 1.4k"
                                                                    },
                                                                    {
                                                                        "size": 1358,
                                                                        "caption": "V8SVGPathSegCurvetoCubicSmoothAbs.cpp 1.4k"
                                                                    },
                                                                    {
                                                                        "size": 1358,
                                                                        "caption": "V8SVGPathSegCurvetoQuadraticRel.cpp 1.4k"
                                                                    },
                                                                    {
                                                                        "size": 1357,
                                                                        "caption": "V8SVGLinearGradientElement.cpp 1.4k"
                                                                    },
                                                                    { "size": 1335, "caption": "V8Rect.cpp 1.3k" },
                                                                    {
                                                                        "size": 1334,
                                                                        "caption": "V8SVGPreserveAspectRatio.cpp 1.3k"
                                                                    },
                                                                    {
                                                                        "size": 1329,
                                                                        "caption": "V8SVGScriptElement.cpp 1.3k"
                                                                    },
                                                                    {
                                                                        "size": 1322,
                                                                        "caption": "V8HTMLProgressElement.cpp 1.3k"
                                                                    },
                                                                    {
                                                                        "size": 1319,
                                                                        "caption": "V8SVGPathSegCurvetoQuadraticAbs.cpp 1.3k"
                                                                    },
                                                                    { "size": 1318, "caption": "V8PopStateEvent.cpp 1.3k" },
                                                                    {
                                                                        "size": 1317,
                                                                        "caption": "V8HTMLAllCollection.cpp 1.3k"
                                                                    },
                                                                    { "size": 1294, "caption": "V8SVGDocument.cpp 1.3k" },
                                                                    {
                                                                        "size": 1291,
                                                                        "caption": "V8HTMLTableColElement.cpp 1.3k"
                                                                    },
                                                                    { "size": 1287, "caption": "V8DocumentType.cpp 1.3k" },
                                                                    { "size": 1287, "caption": "V8DOMMimeType.cpp 1.3k" },
                                                                    { "size": 1287, "caption": "V8Counter.cpp 1.3k" },
                                                                    { "size": 1283, "caption": "V8SVGElement.cpp 1.3k" },
                                                                    {
                                                                        "size": 1278,
                                                                        "caption": "V8WebGLContextAttributes.cpp 1.3k"
                                                                    },
                                                                    {
                                                                        "size": 1265,
                                                                        "caption": "V8PageTransitionEvent.cpp 1.3k"
                                                                    },
                                                                    { "size": 1262, "caption": "V8ValidityState.cpp 1.3k" },
                                                                    { "size": 1248, "caption": "V8StyleSheet.cpp 1.2k" },
                                                                    { "size": 1234, "caption": "V8CSSRule.cpp 1.2k" },
                                                                    { "size": 1229, "caption": "V8TimeRanges.cpp 1.2k" },
                                                                    { "size": 1227, "caption": "V8OverflowEvent.cpp 1.2k" },
                                                                    { "size": 1222, "caption": "V8XMLSerializer.cpp 1.2k" },
                                                                    {
                                                                        "size": 1211,
                                                                        "caption": "V8JavaScriptCallFrame.cpp 1.2k"
                                                                    },
                                                                    { "size": 1199, "caption": "V8NodeFilter.cpp 1.2k" },
                                                                    { "size": 1192, "caption": "V8File.cpp 1.2k" },
                                                                    { "size": 1188, "caption": "V8CanvasGradient.cpp 1.2k" },
                                                                    { "size": 1179, "caption": "V8SVGZoomEvent.cpp 1.2k" },
                                                                    {
                                                                        "size": 1179,
                                                                        "caption": "V8SVGFEPointLightElement.cpp 1.2k"
                                                                    },
                                                                    { "size": 1173, "caption": "V8RGBColor.cpp 1.2k" },
                                                                    { "size": 1161, "caption": "V8FileList.cpp 1.2k" },
                                                                    { "size": 1158, "caption": "V8HTMLHRElement.cpp 1.2k" },
                                                                    {
                                                                        "size": 1152,
                                                                        "caption": "V8SVGAnimatedString.cpp 1.2k"
                                                                    },
                                                                    {
                                                                        "size": 1150,
                                                                        "caption": "V8ProcessingInstruction.cpp 1.1k"
                                                                    },
                                                                    { "size": 1149, "caption": "V8Performance.cpp 1.1k" },
                                                                    { "size": 1149, "caption": "V8NodeList.cpp 1.1k" },
                                                                    { "size": 1142, "caption": "V8DOMParser.cpp 1.1k" },
                                                                    {
                                                                        "size": 1140,
                                                                        "caption": "V8HTMLStyleElement.cpp 1.1k"
                                                                    },
                                                                    {
                                                                        "size": 1128,
                                                                        "caption": "V8HTMLOListElement.cpp 1.1k"
                                                                    },
                                                                    { "size": 1128, "caption": "V8Screen.cpp 1.1k" },
                                                                    { "size": 1125, "caption": "V8TouchList.cpp 1.1k" },
                                                                    {
                                                                        "size": 1124,
                                                                        "caption": "V8HTMLCanvasElement.cpp 1.1k"
                                                                    },
                                                                    { "size": 1110, "caption": "V8StyleMedia.cpp 1.1k" },
                                                                    { "size": 1106, "caption": "V8Touch.cpp 1.1k" },
                                                                    { "size": 1092, "caption": "V8IDBIndex.cpp 1.1k" },
                                                                    { "size": 1089, "caption": "V8XPathNSResolver.cpp 1.1k" },
                                                                    {
                                                                        "size": 1084,
                                                                        "caption": "V8HTMLBaseFontElement.cpp 1.1k"
                                                                    },
                                                                    {
                                                                        "size": 1076,
                                                                        "caption": "V8HTMLLabelElement.cpp 1.1k"
                                                                    },
                                                                    { "size": 1073, "caption": "V8HTMLPreElement.cpp 1.1k" },
                                                                    {
                                                                        "size": 1072,
                                                                        "caption": "V8WebKitCSSKeyframeRule.cpp 1.1k"
                                                                    },
                                                                    {
                                                                        "size": 1071,
                                                                        "caption": "V8HTMLTitleElement.cpp 1.1k"
                                                                    },
                                                                    {
                                                                        "size": 1067,
                                                                        "caption": "V8SVGFEDistantLightElement.cpp 1.1k"
                                                                    },
                                                                    {
                                                                        "size": 1055,
                                                                        "caption": "V8ScriptProfileNode.cpp 1.1k"
                                                                    },
                                                                    { "size": 1047, "caption": "V8ClientRect.cpp 1.0k" },
                                                                    { "size": 1044, "caption": "V8StyleSheetList.cpp 1.0k" },
                                                                    { "size": 1043, "caption": "V8CSSImportRule.cpp 1.0k" },
                                                                    { "size": 1039, "caption": "V8CSSStyleRule.cpp 1.0k" },
                                                                    { "size": 1037, "caption": "V8SQLException.cpp 1.0k" },
                                                                    { "size": 1033, "caption": "V8ClientRectList.cpp 1.0k" },
                                                                    {
                                                                        "size": 1032,
                                                                        "caption": "V8IDBDatabaseError.cpp 1.0k"
                                                                    },
                                                                    { "size": 1029, "caption": "V8HTMLMetaElement.cpp 1.0k" },
                                                                    {
                                                                        "size": 1029,
                                                                        "caption": "V8HTMLParamElement.cpp 1.0k"
                                                                    },
                                                                    { "size": 1019, "caption": "V8CSSPageRule.cpp 1.0k" },
                                                                    { "size": 1009, "caption": "V8CSSRuleList.cpp 1.0k" },
                                                                    { "size": 1008, "caption": "V8HTMLLIElement.cpp 1.0k" },
                                                                    {
                                                                        "size": 1008,
                                                                        "caption": "V8SVGPathSegCurvetoQuadraticSmoothRel.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1008,
                                                                        "caption": "V8SVGPathSegMovetoRel.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1008,
                                                                        "caption": "V8SVGPathSegMovetoAbs.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1008,
                                                                        "caption": "V8SVGPathSegLinetoAbs.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1008,
                                                                        "caption": "V8SVGPathSegLinetoRel.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1006,
                                                                        "caption": "V8HTMLOptGroupElement.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1006,
                                                                        "caption": "V8HTMLUListElement.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1005,
                                                                        "caption": "V8HTMLOptionsCollection.cpp 1.0k"
                                                                    },
                                                                    {
                                                                        "size": 1002,
                                                                        "caption": "V8HTMLLegendElement.cpp 1.0k"
                                                                    },
                                                                    { "size": 1002, "caption": "V8SQLResultSet.cpp 1.0k" },
                                                                    { "size": 988, "caption": "V8MessageEvent.cpp 988" },
                                                                    { "size": 981, "caption": "V8ImageData.cpp 981" },
                                                                    {
                                                                        "size": 969,
                                                                        "caption": "V8SVGPathSegCurvetoQuadraticSmoothAbs.cpp 969"
                                                                    },
                                                                    { "size": 969, "caption": "V8HTMLMapElement.cpp 969" },
                                                                    { "size": 967, "caption": "V8CSSValueList.cpp 967" },
                                                                    { "size": 962, "caption": "V8WebGLActiveInfo.cpp 962" },
                                                                    { "size": 960, "caption": "V8SQLError.cpp 960" },
                                                                    { "size": 953, "caption": "V8HTMLFontElement.cpp 953" },
                                                                    { "size": 951, "caption": "V8WebKitPoint.cpp 951" },
                                                                    {
                                                                        "size": 940,
                                                                        "caption": "V8SQLResultSetRowList.cpp 940"
                                                                    },
                                                                    { "size": 935, "caption": "V8CSSVariablesRule.cpp 935" },
                                                                    { "size": 931, "caption": "V8SVGTRefElement.cpp 931" },
                                                                    { "size": 930, "caption": "V8HTMLDListElement.cpp 930" },
                                                                    { "size": 930, "caption": "V8HTMLMenuElement.cpp 930" },
                                                                    {
                                                                        "size": 930,
                                                                        "caption": "V8HTMLDirectoryElement.cpp 930"
                                                                    },
                                                                    {
                                                                        "size": 928,
                                                                        "caption": "V8SVGFEMergeNodeElement.cpp 928"
                                                                    },
                                                                    {
                                                                        "size": 926,
                                                                        "caption": "V8HTMLTableCaptionElement.cpp 926"
                                                                    },
                                                                    {
                                                                        "size": 926,
                                                                        "caption": "V8HTMLIsIndexElement.cpp 926"
                                                                    },
                                                                    { "size": 925, "caption": "V8SVGAnimatedNumber.cpp 925" },
                                                                    {
                                                                        "size": 918,
                                                                        "caption": "V8HTMLMarqueeElement.cpp 918"
                                                                    },
                                                                    {
                                                                        "size": 898,
                                                                        "caption": "V8SVGAnimatedTransformList.cpp 898"
                                                                    },
                                                                    {
                                                                        "size": 898,
                                                                        "caption": "V8SVGAnimatedLengthList.cpp 898"
                                                                    },
                                                                    {
                                                                        "size": 898,
                                                                        "caption": "V8SVGAnimatedNumberList.cpp 898"
                                                                    },
                                                                    { "size": 896, "caption": "V8PositionError.cpp 896" },
                                                                    { "size": 895, "caption": "V8CSSValue.cpp 895" },
                                                                    {
                                                                        "size": 892,
                                                                        "caption": "V8SVGAnimatedInteger.cpp 892"
                                                                    },
                                                                    {
                                                                        "size": 890,
                                                                        "caption": "V8SVGAnimatedEnumeration.cpp 890"
                                                                    },
                                                                    {
                                                                        "size": 889,
                                                                        "caption": "V8SVGAnimatedBoolean.cpp 889"
                                                                    },
                                                                    {
                                                                        "size": 888,
                                                                        "caption": "V8SVGElementInstanceList.cpp 888"
                                                                    },
                                                                    { "size": 884, "caption": "V8Geoposition.cpp 884" },
                                                                    { "size": 881, "caption": "V8SVGPathSeg.cpp 881" },
                                                                    { "size": 877, "caption": "V8HTMLModElement.cpp 877" },
                                                                    { "size": 877, "caption": "V8HTMLBaseElement.cpp 877" },
                                                                    { "size": 857, "caption": "V8HTMLCollection.cpp 857" },
                                                                    { "size": 844, "caption": "V8SVGNumber.cpp 844" },
                                                                    {
                                                                        "size": 833,
                                                                        "caption": "V8SVGPathSegLinetoHorizontalAbs.cpp 833"
                                                                    },
                                                                    { "size": 833, "caption": "V8SharedWorker.cpp 833" },
                                                                    {
                                                                        "size": 833,
                                                                        "caption": "V8SVGPathSegLinetoVerticalAbs.cpp 833"
                                                                    },
                                                                    {
                                                                        "size": 833,
                                                                        "caption": "V8SVGPathSegLinetoVerticalRel.cpp 833"
                                                                    },
                                                                    { "size": 833, "caption": "V8IDBErrorEvent.cpp 833" },
                                                                    {
                                                                        "size": 833,
                                                                        "caption": "V8SVGPathSegLinetoHorizontalRel.cpp 833"
                                                                    },
                                                                    { "size": 815, "caption": "V8CSSCharsetRule.cpp 815" },
                                                                    { "size": 813, "caption": "V8Geolocation.cpp 813" },
                                                                    { "size": 807, "caption": "V8ScriptProfile.cpp 807" },
                                                                    { "size": 807, "caption": "V8IDBSuccessEvent.cpp 807" },
                                                                    { "size": 801, "caption": "V8HTMLHeadElement.cpp 801" },
                                                                    { "size": 801, "caption": "V8HTMLQuoteElement.cpp 801" },
                                                                    {
                                                                        "size": 801,
                                                                        "caption": "V8HTMLBlockquoteElement.cpp 801"
                                                                    },
                                                                    {
                                                                        "size": 801,
                                                                        "caption": "V8HTMLParagraphElement.cpp 801"
                                                                    },
                                                                    { "size": 801, "caption": "V8HTMLHtmlElement.cpp 801" },
                                                                    { "size": 801, "caption": "V8HTMLBRElement.cpp 801" },
                                                                    {
                                                                        "size": 801,
                                                                        "caption": "V8HTMLHeadingElement.cpp 801"
                                                                    },
                                                                    { "size": 801, "caption": "V8HTMLDivElement.cpp 801" },
                                                                    { "size": 799, "caption": "V8Navigation.cpp 799" },
                                                                    { "size": 793, "caption": "V8CDATASection.cpp 793" },
                                                                    { "size": 793, "caption": "V8Comment.cpp 793" },
                                                                    { "size": 793, "caption": "V8EntityReference.cpp 793" },
                                                                    { "size": 783, "caption": "V8Coordinates.cpp 783" },
                                                                    { "size": 780, "caption": "V8ArrayBufferView.cpp 780" },
                                                                    { "size": 780, "caption": "V8DOMFormData.cpp 780" },
                                                                    { "size": 777, "caption": "V8CSSFontFaceRule.cpp 777" },
                                                                    { "size": 761, "caption": "V8MediaError.cpp 761" },
                                                                    { "size": 753, "caption": "V8MessageChannel.cpp 753" },
                                                                    { "size": 747, "caption": "V8ArrayBuffer.cpp 747" },
                                                                    { "size": 744, "caption": "V8DatabaseCallback.cpp 744" },
                                                                    {
                                                                        "size": 741,
                                                                        "caption": "V8XMLHttpRequestProgressEvent.cpp 741"
                                                                    },
                                                                    {
                                                                        "size": 741,
                                                                        "caption": "V8WebKitCSSTransformValue.cpp 741"
                                                                    },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGFontFaceUriElement.cpp 725"
                                                                    },
                                                                    { "size": 725, "caption": "V8SVGSetElement.cpp 725" },
                                                                    { "size": 725, "caption": "V8SVGGlyphElement.cpp 725" },
                                                                    { "size": 725, "caption": "V8SVGAnimateElement.cpp 725" },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGMissingGlyphElement.cpp 725"
                                                                    },
                                                                    { "size": 725, "caption": "V8HTMLAudioElement.cpp 725" },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGMetadataElement.cpp 725"
                                                                    },
                                                                    { "size": 725, "caption": "V8SVGFEFuncRElement.cpp 725" },
                                                                    { "size": 725, "caption": "V8SVGVKernElement.cpp 725" },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGFontFaceElement.cpp 725"
                                                                    },
                                                                    { "size": 725, "caption": "V8SVGFEFuncBElement.cpp 725" },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGAnimateTransformElement.cpp 725"
                                                                    },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGAnimateColorElement.cpp 725"
                                                                    },
                                                                    { "size": 725, "caption": "V8SVGFEFuncAElement.cpp 725" },
                                                                    { "size": 725, "caption": "V8SVGFEFuncGElement.cpp 725" },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGFontFaceSrcElement.cpp 725"
                                                                    },
                                                                    { "size": 725, "caption": "V8SVGTSpanElement.cpp 725" },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGFontFaceFormatElement.cpp 725"
                                                                    },
                                                                    {
                                                                        "size": 725,
                                                                        "caption": "V8SVGFontFaceNameElement.cpp 725"
                                                                    },
                                                                    { "size": 725, "caption": "V8SVGFontElement.cpp 725" },
                                                                    { "size": 724, "caption": "V8TextMetrics.cpp 724" },
                                                                    { "size": 722, "caption": "V8MemoryInfo.cpp 722" },
                                                                    { "size": 722, "caption": "V8FileError.cpp 722" },
                                                                    { "size": 721, "caption": "V8CanvasPattern.cpp 721" },
                                                                    { "size": 706, "caption": "V8Int32Array.cpp 706" },
                                                                    { "size": 706, "caption": "V8Uint8Array.cpp 706" },
                                                                    { "size": 706, "caption": "V8Float32Array.cpp 706" },
                                                                    {
                                                                        "size": 703,
                                                                        "caption": "V8NotificationCenter.cpp 703"
                                                                    },
                                                                    { "size": 688, "caption": "V8WebGLBuffer.cpp 688" },
                                                                    { "size": 688, "caption": "V8WebGLFramebuffer.cpp 688" },
                                                                    { "size": 688, "caption": "V8WebGLRenderbuffer.cpp 688" },
                                                                    {
                                                                        "size": 688,
                                                                        "caption": "V8WebGLUniformLocation.cpp 688"
                                                                    },
                                                                    { "size": 688, "caption": "V8WebGLTexture.cpp 688" },
                                                                    { "size": 688, "caption": "V8WebGLProgram.cpp 688" },
                                                                    { "size": 680, "caption": "V8Entity.cpp 680" },
                                                                    { "size": 669, "caption": "V8BarInfo.cpp 669" },
                                                                    { "size": 667, "caption": "V8Uint16Array.cpp 667" },
                                                                    { "size": 667, "caption": "V8Int8Array.cpp 667" },
                                                                    { "size": 667, "caption": "V8Int16Array.cpp 667" },
                                                                    { "size": 667, "caption": "V8Uint32Array.cpp 667" },
                                                                    { "size": 654, "caption": "V8SQLTransaction.cpp 654" },
                                                                    { "size": 649, "caption": "V8DeviceMotionEvent.cpp 649" },
                                                                    {
                                                                        "size": 649,
                                                                        "caption": "V8DeviceOrientationEvent.cpp 649"
                                                                    },
                                                                    { "size": 649, "caption": "V8WebGLShader.cpp 649" },
                                                                    {
                                                                        "size": 647,
                                                                        "caption": "V8SQLTransactionSync.cpp 647"
                                                                    },
                                                                    { "size": 627, "caption": "V8CanvasPixelArray.cpp 627" },
                                                                    { "size": 615, "caption": "V8XSLTProcessor.cpp 615" },
                                                                    {
                                                                        "size": 594,
                                                                        "caption": "V8SVGPathSegClosePath.cpp 594"
                                                                    },
                                                                    {
                                                                        "size": 560,
                                                                        "caption": "V8SQLStatementCallback.cpp 560"
                                                                    },
                                                                    { "size": 522, "caption": "V8IDBEvent.cpp 522" },
                                                                    {
                                                                        "size": 496,
                                                                        "caption": "V8SQLTransactionSyncCallback.cpp 496"
                                                                    },
                                                                    {
                                                                        "size": 496,
                                                                        "caption": "V8SQLTransactionCallback.cpp 496"
                                                                    },
                                                                    {
                                                                        "size": 496,
                                                                        "caption": "V8SQLTransactionErrorCallback.cpp 496"
                                                                    },
                                                                    { "size": 486, "caption": "V8Notation.cpp 486" },
                                                                    {
                                                                        "size": 385,
                                                                        "caption": "V8CanvasRenderingContext.cpp 385"
                                                                    },
                                                                    {
                                                                        "size": 353,
                                                                        "caption": "V8SVGRenderingIntent.cpp 353"
                                                                    },
                                                                    { "size": 353, "caption": "V8SVGUnitTypes.cpp 353" },
                                                                    { "size": 316, "caption": "V8SVGHKernElement.cpp 316" },
                                                                    {
                                                                        "size": 248,
                                                                        "caption": "V8SQLStatementErrorCallback.cpp 248"
                                                                    },
                                                                    { "size": 39, "caption": "V8IDBKey.cpp 39" }
                                                                ]
                                                            },
                                                            {
                                                                "size": 290086,
                                                                "caption": "InspectorBackendDispatcher.cpp 290.1k"
                                                            },
                                                            { "size": 66991, "caption": "InspectorFrontend.cpp 67.0k" }
                                                        ]
                                                    },
                                                    {
                                                        "size": 248536,
                                                        "caption": "protoc_out 248.5k",
                                                        "children": [
                                                            {
                                                                "size": 193507,
                                                                "caption": "chrome 193.5k",
                                                                "children": [{
                                                                        "size": 193507,
                                                                        "caption": "browser 193.5k",
                                                                        "children": [
                                                                            {
                                                                                "size": 129926,
                                                                                "caption": "sync 129.9k",
                                                                                "children": [{
                                                                                        "size": 129926,
                                                                                        "caption": "protocol 129.9k",
                                                                                        "children": [
                                                                                            { "size": 59194, "caption": "sync.pb.cc 59.2k" },
                                                                                            {
                                                                                                "size": 19715,
                                                                                                "caption": "autofill_specifics.pb.cc 19.7k"
                                                                                            },
                                                                                            {
                                                                                                "size": 13753,
                                                                                                "caption": "session_specifics.pb.cc 13.8k"
                                                                                            },
                                                                                            {
                                                                                                "size": 7657,
                                                                                                "caption": "password_specifics.pb.cc 7.7k"
                                                                                            },
                                                                                            {
                                                                                                "size": 7311,
                                                                                                "caption": "nigori_specifics.pb.cc 7.3k"
                                                                                            },
                                                                                            {
                                                                                                "size": 4190,
                                                                                                "caption": "extension_specifics.pb.cc 4.2k"
                                                                                            },
                                                                                            {
                                                                                                "size": 4116,
                                                                                                "caption": "typed_url_specifics.pb.cc 4.1k"
                                                                                            },
                                                                                            {
                                                                                                "size": 3759,
                                                                                                "caption": "theme_specifics.pb.cc 3.8k"
                                                                                            },
                                                                                            {
                                                                                                "size": 2719,
                                                                                                "caption": "bookmark_specifics.pb.cc 2.7k"
                                                                                            },
                                                                                            {
                                                                                                "size": 2663,
                                                                                                "caption": "preference_specifics.pb.cc 2.7k"
                                                                                            },
                                                                                            {
                                                                                                "size": 2604,
                                                                                                "caption": "encryption.pb.cc 2.6k"
                                                                                            },
                                                                                            {
                                                                                                "size": 2245,
                                                                                                "caption": "app_specifics.pb.cc 2.2k"
                                                                                            }
                                                                                        ]
                                                                                    }]
                                                                            },
                                                                            {
                                                                                ...
                                                                                "children": [{
                                                                                        ...
                                                                                        "children": [
                                                                                            {
                                                                                                "size": 20305,
                                                                                                "caption": "extension.pb.cc 20.3k"
                                                                                            },
                                                                                            { "size": 14783, "caption": "dom.pb.cc 14.8k" },
                                                                                            { "size": 11201, "caption": "web.pb.cc 11.2k" },
                                                                                            { "size": 6232, "caption": "chrome.pb.cc 6.2k" },
                                                                                            { "size": 4235, "caption": "common.pb.cc 4.2k" },
                                                                                            { "size": 3839, "caption": "math.pb.cc 3.8k" }, {
                                                                                                "size": 2986,
                                                                                                "caption": "annotations.pb.cc 3.0k"
                                                                                            }
                                                                                        ]
                                                                                    }]
                                                                            }
                                                            ...
                                                            {
                                                                "size": 34127,
                                                                "caption": "google 34.1k",
                                                                "children": [{
                                                                        "size": 34127,
                                                                        "caption": "cacheinvalidation 34.1k",
                                                                        "children": [
                                                                            { "size": 34127, "caption": "types.pb.cc 34.1k" }
                                                                        ]
                                                                    }]
                                                            },
                                                            {
                                                                "size": 20902,
                                                                "caption": "remoting 20.9k",
                                                                "children": [{
                                                                        "size": 20902,
                                                                        "caption": "base 20.9k",
                                                                        "children": [{
                                                                                "size": 20902,
                                                                                "caption": "protocol 20.9k",
                                                                                "children": [{
                                                                                        "size": 20902,
                                                                                        "caption": "chromotocol.pb.cc 20.9k"
                                                                                    }]
                                                                            }]
                                                                    }]
                                                            }
                                                    ...
                                                    {
                                                        "size": 76630,
                                                        "caption": "webkit 76.6k",
                                                        "children": [
                                                            { "size": 14499, "caption": "HTMLNames.cpp 14.5k" },
                                                            { "size": 14092, "caption": "CSSGrammar.cpp 14.1k" },
                                                            { "size": 11739, "caption": "SVGNames.cpp 11.7k" }, {
                                                                "size": 7632,
                                                                "caption": "V8SVGElementWrapperFactory.cpp 7.6k"
                                                            },
                                                            {
                                                                "size": 7581,
                                                                "caption": "V8HTMLElementWrapperFactory.cpp 7.6k"
                                                            },
                                                            { "size": 6908, "caption": "SVGElementFactory.cpp 6.9k" },
                                                            { "size": 6581, "caption": "XPathGrammar.cpp 6.6k" },
                                                            { "size": 5227, "caption": "HTMLElementFactory.cpp 5.2k" },
                                                            { "size": 1448, "caption": "MathMLNames.cpp 1.4k" },
                                                            { "size": 383, "caption": "XLinkNames.cpp 383" },
                                                            { "size": 255, "caption": "XMLNames.cpp 255" },
                                                            { "size": 157, "caption": "XMLNSNames.cpp 157" },
                                                            { "size": 128, "caption": "HTMLEntityTable.cpp 128" }
                                                        ]
                                                    },
                                                    {
                                                        "size": 19632,
                                                        ...
                                                        "children": [
                                                            {
                                                                "size": 10987,
                                                                "caption": "gl_bindings_autogen_mock.cc 11.0k"
                                                            },
                                                            { "size": 5683, "caption": "gl_bindings_autogen_gl.cc 5.7k" },
                                                            {
                                                                "size": 1356,
                                                                "caption": "gl_bindings_autogen_glx.cc 1.4k"
                                                            },
                                                            {
                                                                "size": 1213,
                                                                "caption": "gl_bindings_autogen_egl.cc 1.2k"
                                                            },
                                                            {
                                                                "size": 393,
                                                                "caption": "gl_bindings_autogen_osmesa.cc 393"
                                                            }
                                                        ]
                                                    },
                                                    { "size": 1213, "caption": "libraries-empty.cc 1.2k" }
                                                ]
                                            }]
                                    },
                                    {
                                        "size": 59118,
                                        "caption": "obj.target 59.1k",
                                        "children": [{
                                                "size": 59118,
                                                "caption": "geni 59.1k",
                                                "children": [
                                                    { "size": 36985, "caption": "glslang_tab.cpp 37.0k" },
                                                    { "size": 11484, "caption": "glslang.cpp 11.5k" },
                                                    { "size": 3927, "caption": "nacl_syscall_handlers.c 3.9k" }, {
                                                        "size": 3812,
                                                        "caption": "gen 3.8k",
                                                        "children": [{
                                                                "size": 3812,
                                                                "caption": "native_client 3.8k",
                                                                "children": [{
                                                                        "size": 3812,
                                                                        "caption": "src 3.8k",
                                                                        "children": [{
                                                                                ...
                                                                                "children": [{
                                                                                        "size": 3812,
                                                                                        "caption": "npruntime 3.8k",
                                                                                        "children": [
                                                                                            {
                                                                                                "size": 2398,
                                                                                                "caption": "npmodule_rpc_server.cc 2.4k"
                                                                                            },
                                                                                            {
                                                                                                "size": 1309,
                                                                                                "caption": "npnavigator_rpc_client.cc 1.3k"
                                                                                            },
                                                                                            {
                                                                                                "size": 105,
                                                                                                "caption": "npupcall_rpc_server.cc 105"
                                                                                            }
                                                                                        ]
                                                                                    }]
                                                                            }]
                                                    ...
                                                    { "size": 2175, "caption": "ffmpeg_stubs.cc 2.2k" },
                                                    { "size": 735, "caption": "il_stubs.cc 735" }
                                                ]
                                            }]
                                    }
                                ]
                                ...
                                "children": [
                                    {
                                        ...
                                        "caption": "ia32 502.2k",
                                        "children": [
                                            { "size": 200631, "caption": "codegen-ia32.cc 200.6k" },
                                            { "size": 71875, "caption": "code-stubs-ia32.cc 71.9k" },
                                            { "size": 51602, "caption": "full-codegen-ia32.cc 51.6k" },
                                            { "size": 37514, "caption": "stub-cache-ia32.cc 37.5k" },
                                            { "size": 23907, "caption": "assembler-ia32.cc 23.9k" },
                                            { "size": 23785, "caption": "virtual-frame-ia32.cc 23.8k" },
                                            { "size": 23317, "caption": "ic-ia32.cc 23.3k" },
                                            { "size": 21957, "caption": "macro-assembler-ia32.cc 22.0k" }, {
                                                "size": 18963,
                                                "caption": "regexp-macro-assembler-ia32.cc 19.0k"
                                            },
                                            { "size": 17984, "caption": "builtins-ia32.cc 18.0k" },
                                            { "size": 6772, "caption": "jump-target-ia32.cc 6.8k" },
                                            { "size": 2083, "caption": "register-allocator-ia32.cc 2.1k" },
                                            { "size": 1360, "caption": "debug-ia32.cc 1.4k" },
                                            { "size": 228, "caption": "frames-ia32.cc 228" },
                                            { "size": 168, "caption": "macro-assembler-ia32.h 168" },
                                            { "size": 14, "caption": "cpu-ia32.cc 14" }
                                        ]
                                    },
                                    { "size": 141440, "caption": "runtime.cc 141.4k" },
                                    { "size": 90047, "caption": "objects.cc 90.0k" },
                                    { "size": 57813, "caption": "parser.cc 57.8k" },
                                    { "size": 52468, "caption": "api.cc 52.5k" },
                                    { "size": 44726, "caption": "jsregexp.cc 44.7k" },
                                    { "size": 35889, "caption": "heap.cc 35.9k" },
                                    { "size": 29278, "caption": "scanner.cc 29.3k" },
                                    { "size": 28642, "caption": "factory.cc 28.6k" },
                                    { "size": 24591, "caption": "bootstrapper.cc 24.6k" },
                                    { "size": 23574, "caption": "debug.cc 23.6k" },
                                    { "size": 22630, "caption": "conversions.cc 22.6k" },
                                    { "size": 19601, "caption": "mark-compact.cc 19.6k" },
                                    { "size": 18781, "caption": "handles.cc 18.8k" },
                                    { "size": 18469, "caption": "serialize.cc 18.5k" },
                                    { "size": 18047, "caption": "spaces.cc 18.0k" },
                                    { "size": 17204, "caption": "ic.cc 17.2k" },
                                    { "size": 16965, "caption": "stub-cache.cc 17.0k" },
                                    { "size": 15797, "caption": "builtins.cc 15.8k" },
                                    { "size": 14423, "caption": "log.cc 14.4k" },
                                    {
                                        "size": 13863,
                                        "caption": "third_party 13.9k",
                                        "children": [{
                                                "size": 13863,
                                                "caption": "dtoa 13.9k",
                                                "children": [{ "size": 13863, "caption": "dtoa.c 13.9k" }]
                                            }]
                                    },
                                    { "size": 13464, "caption": "jump-target-heavy.cc 13.5k" },
                                    { "size": 11049, "caption": "full-codegen.cc 11.0k" },
                                    { "size": 10272, "caption": "heap-profiler.cc 10.3k" },
                                    { "size": 10054, "caption": "liveedit.cc 10.1k" },
                                    { "size": 9075, "caption": "frames.cc 9.1k" },
                                    { "size": 8745, "caption": "top.cc 8.7k" },
                                    { "size": 8597, "caption": "data-flow.cc 8.6k" },
                                    { "size": 8514, "caption": "execution.cc 8.5k" },
                                    { "size": 7888, "caption": "unicode.cc 7.9k" },
                                    { "size": 7884, "caption": "string-stream.cc 7.9k" },
                                    { "size": 7553, "caption": "compiler.cc 7.6k" },
                                    { "size": 7226, "caption": "profile-generator.cc 7.2k" },
                                    { "size": 6562, "caption": "rewriter.cc 6.6k" },
                                    { "size": 6133, "caption": "compilation-cache.cc 6.1k" },
                                    { "size": 5287, "caption": "scopes.cc 5.3k" },
                                    { "size": 4832, "caption": "cpu-profiler.cc 4.8k" },
                                    { "size": 4588, "caption": "fixed-dtoa.cc 4.6k" },
                                    { "size": 4578, "caption": "ast.cc 4.6k" },
                                    { "size": 4253, "caption": "virtual-frame-heavy.cc 4.3k" },
                                    { "size": 3861, "caption": "accessors.cc 3.9k" },
                                    { "size": 3787, "caption": "codegen.cc 3.8k" },
                                    { "size": 3680, "caption": "fast-dtoa.cc 3.7k" },
                                    { "size": 3443, "caption": "platform-linux.cc 3.4k" },
                                    { "size": 3219, "caption": "log-utils.cc 3.2k" },
                                    { "size": 2750, "caption": "flags.cc 2.8k" },
                                    { "size": 2705, "caption": "assembler.cc 2.7k" },
                                    { "size": 2517, "caption": "global-handles.cc 2.5k" },
                                    { "size": 2211, "caption": "splay-tree-inl.h 2.2k" },
                                    { "size": 2003, "caption": "messages.cc 2.0k" },
                                    { "size": 1774, "caption": "v8threads.cc 1.8k" },
                                    { "size": 1509, "caption": "objects.h 1.5k" },
                                    { "size": 1354, "caption": "conversions-inl.h 1.4k" },
                                    { "size": 1329, "caption": "code-stubs.cc 1.3k" },
                                    { "size": 1204, "caption": "contexts.cc 1.2k" },
                                    { "size": 936, "caption": "dateparser.cc 936" },
                                    { "size": 932, "caption": "hashmap.cc 932" },
                                    { "size": 913, "caption": "regexp-macro-assembler.cc 913" },
                                    { "size": 870, "caption": "scopeinfo.cc 870" },
                                    { "size": 849, "caption": "func-name-inferrer.cc 849" },
                                    { "size": 825, "caption": "register-allocator.cc 825" },
                                    { "size": 746, "caption": "utils.cc 746" },
                                    { "size": 741, "caption": "objects-visiting.h 741" },
                                    { "size": 631, "caption": "v8.cc 631" },
                                    { "size": 631, "caption": "platform-posix.cc 631" },
                                    { "size": 585, "caption": "snapshot-common.cc 585" },
                                    { "size": 539, "caption": "allocation.cc 539" },
                                    { "size": 477, "caption": "zone.cc 477" },
                                    { "size": 450, "caption": "circular-queue.cc 450" },
                                    { "size": 365, "caption": "regexp-stack.cc 365" },
                                    { "size": 353, "caption": "heap-inl.h 353" },
                                    { "size": 335, "caption": "objects-inl.h 335" },
                                    { "size": 326, "caption": "jump-target.cc 326" },
                                    { "size": 287, "caption": "dtoa.cc 287" },
                                    { "size": 281, "caption": "virtual-frame-heavy-inl.h 281" },
                                    { "size": 220, "caption": "checks.cc 220" },
                                    { "size": 219, "caption": "objects-visiting.cc 219" },
                                    { "size": 217, "caption": "variables.cc 217" },
                                    { "size": 202, "caption": "vm-state-inl.h 202" },
                                    { "size": 182, "caption": "counters.cc 182" },
                                    { "size": 173, "caption": "type-info.cc 173" },
                                    { "size": 170, "caption": "diy-fp.cc 170" },
                                    { "size": 160, "caption": "handles-inl.h 160" },
                                    { "size": 158, "caption": "version.cc 158" },
                                    { "size": 124, "caption": "frame-element.cc 124" },
                                    { "size": 84, "caption": "spaces-inl.h 84" },
                                    { "size": 73, "caption": "utils.h 73" },
                                    { "size": 60, "caption": "top.h 60" },
                                    { "size": 41, "caption": "zone.h 41" },
                                    { "size": 36, "caption": "allocation.h 36" },
                                    { "size": 33, "caption": "oprofile-agent.cc 33" },
                                    { "size": 33, "caption": "frames.h 33" },
                                    { "size": 25, "caption": "handles.h 25" },
                                    { "size": 23, "caption": "v8.h 23" },
                                    { "size": 11, "caption": "heap-profiler.h 11" },
                                    { "size": 8, "caption": "debug.h 8" },
                                    { "size": 8, "caption": "api.h 8" },
                                    { "size": 8, "caption": "log-utils.h 8" }
                                ]
                            }]
                    },
                    {
                        ...
                        "children": [
                            {
                                ...
                                "caption": "http 269.0k",
                                "children": [
                                    { "size": 35135, "caption": "http_cache_transaction.cc 35.1k" },
                                    { "size": 30880, "caption": "http_network_transaction.cc 30.9k" },
                                    { "size": 21493, "caption": "http_cache.cc 21.5k" },
                                    { "size": 21049, "caption": "http_stream_request.cc 21.0k" },
                                    { "size": 19533, "caption": "http_response_headers.cc 19.5k" },
                                    { "size": 12831, "caption": "http_auth_gssapi_posix.cc 12.8k" },
                                    { "size": 11726, "caption": "http_proxy_client_socket.cc 11.7k" },
                                    { "size": 10424, "caption": "http_util.cc 10.4k" },
                                    { "size": 10116, "caption": "http_stream_parser.cc 10.1k" },
                                    { "size": 9543, "caption": "http_auth_handler_digest.cc 9.5k" },
                                    { "size": 8638, "caption": "http_auth_controller.cc 8.6k" },
                                    { "size": 7863, "caption": "partial_data.cc 7.9k" },
                                    { "size": 7343, "caption": "http_network_session.cc 7.3k" },
                                    { "size": 7174, "caption": "http_auth_cache.cc 7.2k" },
                                    { "size": 5750, "caption": "http_auth_handler_negotiate.cc 5.8k" },
                                    { "size": 5539, "caption": "http_proxy_client_socket_pool.cc 5.5k" },
                                    { "size": 4671, "caption": "http_auth.cc 4.7k" },
                                    { "size": 4635, "caption": "http_auth_handler_factory.cc 4.6k" },
                                    { "size": 4459, "caption": "http_request_headers.cc 4.5k" },
                                    { "size": 4337, "caption": "http_response_info.cc 4.3k" },
                                    {
                                        "size": 3859,
                                        "caption": "http_auth_handler_ntlm_portable.cc 3.9k"
                                    },
                                    { "size": 3427, "caption": "http_auth_handler.cc 3.4k" },
                                    { "size": 3201, "caption": "http_network_layer.cc 3.2k" },
                                    { "size": 2209, "caption": "http_alternate_protocols.cc 2.2k" },
                                    { "size": 2166, "caption": "http_stream_factory.cc 2.2k" },
                                    { "size": 1943, "caption": "http_auth_handler_ntlm.cc 1.9k" },
                                    { "size": 1756, "caption": "md4.cc 1.8k" },
                                    { "size": 1528, "caption": "http_vary_data.cc 1.5k" },
                                    { "size": 1519, "caption": "http_auth_handler_basic.cc 1.5k" },
                                    { "size": 1182, "caption": "http_chunked_decoder.cc 1.2k" },
                                    { "size": 908, "caption": "http_util_icu.cc 908" },
                                    { "size": 779, "caption": "http_basic_stream.cc 779" },
                                    { "size": 616, "caption": "des.cc 616" },
                                    { "size": 455, "caption": "http_byte_range.cc 455" },
                                    { "size": 192, "caption": "http_auth_filter.cc 192" },
                                    { "size": 63, "caption": "url_security_manager.cc 63" },
                                    { "size": 41, "caption": "url_security_manager_posix.cc 41" }
                                ]
                            },
                            {
                                "size": 225943,
                                "caption": "base 225.9k",
                                "children": [
                                    { "size": 30922, "caption": "net_util.cc 30.9k" },
                                    { "size": 26223, "caption": "cookie_monster.cc 26.2k" },
                                    { "size": 15826, "caption": "sdch_manager.cc 15.8k" },
                                    { "size": 14598, "caption": "host_resolver_impl.cc 14.6k" },
                                    { "size": 12114, "caption": "sdch_filter.cc 12.1k" },
                                    { "size": 10967, "caption": "mime_util.cc 11.0k" },
                                    { "size": 10918, "caption": "net_log.cc 10.9k" },
                                    { "size": 10129, "caption": "transport_security_state.cc 10.1k" },
                                    { "size": 5859, "caption": "dnssec_chain_verifier.cc 5.9k" },
                                    { "size": 5795, "caption": "x509_certificate_nss.cc 5.8k" },
                                    { "size": 5749, "caption": "file_stream_posix.cc 5.7k" },
                                    { "size": 5529, "caption": "network_change_notifier_linux.cc 5.5k" },
                                    { "size": 4802, "caption": "mime_sniffer.cc 4.8k" },
                                    { "size": 4132, "caption": "x509_certificate.cc 4.1k" },
                                    { "size": 3939, "caption": "filter.cc 3.9k" },
                                    { "size": 3914, "caption": "dnssec_keyset.cc 3.9k" },
                                    { "size": 3575, "caption": "directory_lister.cc 3.6k" },
                                    { "size": 3566, "caption": "network_change_notifier.cc 3.6k" },
                                    { "size": 3363, "caption": "host_mapping_rules.cc 3.4k" },
                                    { "size": 3316, "caption": "escape.cc 3.3k" },
                                    { "size": 3019, "caption": "listen_socket.cc 3.0k" },
                                    { "size": 2953, "caption": "connection_type_histograms.cc 3.0k" },
                                    { "size": 2532, "caption": "registry_controlled_domain.cc 2.5k" },
                                    { "size": 2467, "caption": "data_url.cc 2.5k" },
                                    { "size": 2212, "caption": "upload_data_stream.cc 2.2k" },
                                    { "size": 2063, "caption": "io_buffer.cc 2.1k" },
                                    { "size": 1858, "caption": "address_list.cc 1.9k" },
                                    { "size": 1732, "caption": "gzip_header.cc 1.7k" },
                                    { "size": 1709, "caption": "host_cache.cc 1.7k" },
                                    { "size": 1675, "caption": "upload_data.cc 1.7k" },
                                    { "size": 1672, "caption": "gzip_filter.cc 1.7k" },
                                    { "size": 1448, "caption": "nss_memio.c 1.4k" },
                                    { "size": 1401, "caption": "mapped_host_resolver.cc 1.4k" },
                                    { "size": 1348, "caption": "host_port_pair.cc 1.3k" },
                                    { "size": 1253, "caption": "ev_root_ca_metadata.cc 1.3k" },
                                    { "size": 1161, "caption": "cert_database_nss.cc 1.2k" },
                                    {
                                        "size": 1156,
                                        "caption": "network_change_notifier_netlink_linux.cc 1.2k"
                                    },
                                    { "size": 1133, "caption": "cert_verifier.cc 1.1k" },
                                    { "size": 1028, "caption": "forwarding_net_log.cc 1.0k" },
                                    { "size": 816, "caption": "x509_cert_types.cc 816" },
                                    { "size": 806, "caption": "net_util_posix.cc 806" },
                                    { "size": 685, "caption": "host_resolver.cc 685" },
                                    { "size": 637, "caption": "ssl_client_auth_cache.cc 637" },
                                    { "size": 557, "caption": "dns_util.cc 557" },
                                    { "size": 512, "caption": "platform_mime_util_linux.cc 512" },
                                    { "size": 495, "caption": "host_resolver_proc.cc 495" },
                                    { "size": 420, "caption": "capturing_net_log.cc 420" },
                                    { "size": 374, "caption": "cert_status_flags.cc 374" },
                                    { "size": 353, "caption": "address_list_net_log_param.cc 353" },
                                    { "size": 341, "caption": "dns_reload_timer.cc 341" },
                                    { "size": 280, "caption": "static_cookie_policy.cc 280" },
                                    { "size": 253, "caption": "ssl_cipher_suite_names.cc 253" },
                                    { "size": 148, "caption": "ssl_config_service.cc 148" },
                                    { "size": 78, "caption": "net_module.cc 78" },
                                    { "size": 61, "caption": "keygen_handler_nss.cc 61" },
                                    { "size": 43, "caption": "net_errors.cc 43" },
                                    { "size": 28, "caption": "completion_callback.h 28" }
                                ]
                            },
                            {
                                "size": 186372,
                                "caption": "disk_cache 186.4k",
                                "children": [
                                    { "size": 64997, "caption": "backend_impl.cc 65.0k" },
                                    { "size": 30690, "caption": "entry_impl.cc 30.7k" },
                                    { "size": 20155, "caption": "eviction.cc 20.2k" },
                                    { "size": 13586, "caption": "block_files.cc 13.6k" },
                                    { "size": 10708, "caption": "sparse_control.cc 10.7k" },
                                    { "size": 9700, "caption": "rankings.cc 9.7k" },
                                    { "size": 8138, "caption": "mem_entry_impl.cc 8.1k" },
                                    { "size": 7898, "caption": "in_flight_backend_io.cc 7.9k" },
                                    { "size": 4642, "caption": "mem_backend_impl.cc 4.6k" },
                                    { "size": 4045, "caption": "file_posix.cc 4.0k" },
                                    { "size": 3924, "caption": "bitmap.cc 3.9k" },
                                    { "size": 2782, "caption": "stats.cc 2.8k" },
                                    { "size": 1273, "caption": "stats_histogram.cc 1.3k" },
                                    { "size": 1091, "caption": "in_flight_io.cc 1.1k" },
                                    { "size": 839, "caption": "mapped_file_posix.cc 839" },
                                    { "size": 429, "caption": "cache_util_posix.cc 429" },
                                    { "size": 416, "caption": "addr.cc 416" },
                                    { "size": 415, "caption": "storage_block-inl.h 415" },
                                    { "size": 267, "caption": "mem_rankings.cc 267" },
                                    { "size": 247, "caption": "hash.cc 247" },
                                    { "size": 70, "caption": "trace.cc 70" },
                                    { "size": 60, "caption": "file_lock.cc 60" }
                                ]
                            },
                            {
                                "size": 119868,
                                "caption": "third_party 119.9k",
                                "children": [
                                    {
                                        "size": 116221,
                                        "caption": "nss 116.2k",
                                        "children": [{
                                                ...
                                                "caption": "ssl 116.2k",
                                                "children": [
                                                    { "size": 47969, "caption": "ssl3con.c 48.0k" },
                                                    { "size": 16549, "caption": "sslcon.c 16.5k" },
                                                    { "size": 11308, "caption": "sslsock.c 11.3k" },
                                                    { "size": 9572, "caption": "ssl3ext.c 9.6k" },
                                                    { "size": 5142, "caption": "ssl3ecc.c 5.1k" },
                                                    {
                                                        "size": 4795,
                                                        "caption": "bodge 4.8k",
                                                        "children": [
                                                            { "size": 4141, "caption": "loader.c 4.1k" },
                                                            { "size": 607, "caption": "genload.c 607" },
                                                            { "size": 47, "caption": "secure_memcmp.c 47" }
                                                        ]
                                                    },
                                                    { "size": 4758, "caption": "sslsecur.c 4.8k" },
                                                    { "size": 4253, "caption": "snapstart.c 4.3k" },
                                                    { "size": 3050, "caption": "derive.c 3.0k" },
                                                    { "size": 1845, "caption": "sslsnce.c 1.8k" },
                                                    { "size": 1618, "caption": "sslnonce.c 1.6k" },
                                                    { "size": 1527, "caption": "sslgathr.c 1.5k" },
                                                    { "size": 837, "caption": "sslinfo.c 837" },
                                                    { "size": 804, "caption": "ssl3gthr.c 804" },
                                                    { "size": 665, "caption": "ssldef.c 665" },
                                                    { "size": 389, "caption": "sslmutex.c 389" },
                                                    { "size": 362, "caption": "cmpcert.c 362" },
                                                    { "size": 308, "caption": "sslauth.c 308" },
                                                    { "size": 166, "caption": "sslreveal.c 166" },
                                                    { "size": 159, "caption": "fnv1a64.c 159" },
                                                    { "size": 102, "caption": "sslerr.c 102" },
                                                    { "size": 43, "caption": "unix_err.c 43" }
                                                ]
                                            }]
                                    },
                                    {
                                        "size": 3647,
                                        "caption": "mozilla_security_manager 3.6k",
                                        "children": [
                                            { "size": 2226, "caption": "nsKeygenHandler.cpp 2.2k" },
                                            { "size": 1421, "caption": "nsPKCS12Blob.cpp 1.4k" }
                                        ]
                                    }
                                ]
                            },
                            {
                                "size": 107862,
                                "caption": "socket 107.9k",
                                "children": [
                                    { "size": 21107, "caption": "client_socket_pool_base.cc 21.1k" },
                                    { "size": 20943, "caption": "ssl_client_socket_nss.cc 20.9k" },
                                    { "size": 11838, "caption": "tcp_client_socket_libevent.cc 11.8k" },
                                    { "size": 11512, "caption": "ssl_client_socket_pool.cc 11.5k" },
                                    { "size": 9990, "caption": "socks5_client_socket.cc 10.0k" },
                                    { "size": 8346, "caption": "socks_client_socket.cc 8.3k" },
                                    { "size": 7635, "caption": "tcp_client_socket_pool.cc 7.6k" },
                                    { "size": 4484, "caption": "socks_client_socket_pool.cc 4.5k" },
                                    { "size": 4415, "caption": "client_socket.cc 4.4k" },
                                    { "size": 3994, "caption": "client_socket_handle.cc 4.0k" },
                                    { "size": 3167, "caption": "client_socket_pool_histograms.cc 3.2k" },
                                    { "size": 408, "caption": "client_socket_factory.cc 408" },
                                    { "size": 23, "caption": "client_socket_pool.cc 23" }
                                ]
                            },
                            {
                                "size": 98351,
                                "caption": "spdy 98.4k",
                                "children": [
                                    { "size": 37071, "caption": "spdy_session.cc 37.1k" },
                                    { "size": 19298, "caption": "spdy_framer.cc 19.3k" },
                                    { "size": 16260, "caption": "spdy_http_stream.cc 16.3k" },
                                    { "size": 16157, "caption": "spdy_stream.cc 16.2k" },
                                    { "size": 6895, "caption": "spdy_session_pool.cc 6.9k" },
                                    { "size": 1158, "caption": "spdy_frame_builder.cc 1.2k" },
                                    { "size": 1030, "caption": "spdy_settings_storage.cc 1.0k" },
                                    { "size": 374, "caption": "spdy_io_buffer.cc 374" },
                                    { "size": 108, "caption": "spdy_protocol.h 108" }
                                ]
                            },
                            {
                                "size": 98162,
                                "caption": "proxy 98.2k",
                                "children": [
                                    { "size": 26815, "caption": "proxy_config_service_linux.cc 26.8k" },
                                    { "size": 12014, "caption": "proxy_service.cc 12.0k" },
                                    { "size": 9456, "caption": "multi_threaded_proxy_resolver.cc 9.5k" },
                                    { "size": 8801, "caption": "proxy_config.cc 8.8k" },
                                    { "size": 8777, "caption": "init_proxy_resolver.cc 8.8k" },
                                    { "size": 6862, "caption": "proxy_bypass_rules.cc 6.9k" },
                                    { "size": 6084, "caption": "proxy_resolver_js_bindings.cc 6.1k" },
                                    { "size": 4198, "caption": "proxy_server.cc 4.2k" },
                                    { "size": 3983, "caption": "proxy_list.cc 4.0k" },
                                    { "size": 3548, "caption": "proxy_script_fetcher.cc 3.5k" },
                                    { "size": 3503, "caption": "proxy_resolver_v8.cc 3.5k" },
                                    { "size": 3128, "caption": "sync_host_resolver_bridge.cc 3.1k" },
                                    { "size": 709, "caption": "proxy_resolver_script_data.cc 709" },
                                    { "size": 284, "caption": "proxy_info.cc 284" }
                                ]
                            },
                            {
                                "size": 95918,
                                "caption": "url_request 95.9k",
                                "children": [
                                    { "size": 28152, "caption": "url_request_job.cc 28.2k" },
                                    { "size": 19927, "caption": "url_request_http_job.cc 19.9k" },
                                    { "size": 10736, "caption": "url_request.cc 10.7k" },
                                    { "size": 7756, "caption": "url_request_ftp_job.cc 7.8k" },
                                    { "size": 6711, "caption": "view_cache_helper.cc 6.7k" },
                                    { "size": 4814, "caption": "url_request_file_job.cc 4.8k" },
                                    { "size": 3746, "caption": "url_request_filter.cc 3.7k" },
                                    { "size": 3593, "caption": "https_prober.cc 3.6k" },
                                    { "size": 3457, "caption": "url_request_file_dir_job.cc 3.5k" },
                                    { "size": 3095, "caption": "url_request_job_manager.cc 3.1k" },
                                    { "size": 1818, "caption": "url_request_job_tracker.cc 1.8k" },
                                    { "size": 617, "caption": "url_request_netlog_params.cc 617" },
                                    { "size": 588, "caption": "url_request_simple_job.cc 588" },
                                    { "size": 279, "caption": "url_request_redirect_job.cc 279" },
                                    { "size": 260, "caption": "url_request_about_job.cc 260" },
                                    { "size": 218, "caption": "url_request_error_job.cc 218" },
                                    { "size": 139, "caption": "url_request_data_job.cc 139" },
                                    { "size": 12, "caption": "url_request_context.cc 12" }
                                ]
                            },
                            {
                                "size": 68354,
                                "caption": "ftp 68.4k",
                                "children": [
                                    { "size": 21214, "caption": "ftp_network_transaction.cc 21.2k" }, {
                                        "size": 8033,
                                        "caption": "ftp_directory_listing_parser_vms.cc 8.0k"
                                    },
                                    { "size": 6229, "caption": "ftp_util.cc 6.2k" },
                                    { "size": 5404, "caption": "ftp_ctrl_response_buffer.cc 5.4k" }, {
                                        "size": 4954,
                                        "caption": "ftp_directory_listing_parser_mlsd.cc 5.0k"
                                    },
                                    {
                                        "size": 4756,
                                        "caption": "ftp_directory_listing_parser_windows.cc 4.8k"
                                    },
                                    { "size": 4458, "caption": "ftp_directory_listing_buffer.cc 4.5k" }, {
                                        "size": 3900,
                                        "caption": "ftp_directory_listing_parser_ls.cc 3.9k"
                                    },
                                    { "size": 2861, "caption": "ftp_auth_cache.cc 2.9k" },
                                    { "size": 2845, "caption": "ftp_server_type_histograms.cc 2.8k" }, {
                                        "size": 2759,
                                        "caption": "ftp_directory_listing_parser_netware.cc 2.8k"
                                    },
                                    { "size": 889, "caption": "ftp_network_layer.cc 889" },
                                    { "size": 52, "caption": "ftp_directory_listing_parser.cc 52" }
                                ]
                            },
                            {
                                "size": 52905,
                                "caption": "websockets 52.9k",
                                "children": [
                                    { "size": 13810, "caption": "websocket_job.cc 13.8k" },
                                    { "size": 12569, "caption": "websocket.cc 12.6k" },
                                    { "size": 8759, "caption": "websocket_handshake.cc 8.8k" },
                                    { "size": 7219, "caption": "websocket_handshake_handler.cc 7.2k" },
                                    { "size": 5764, "caption": "websocket_throttle.cc 5.8k" },
                                    { "size": 2812, "caption": "websocket_frame_handler.cc 2.8k" },
                                    { "size": 1972, "caption": "websocket_handshake_draft75.cc 2.0k" }
                                ]
                            },
                            {
                                "size": 37939,
                                "caption": "socket_stream 37.9k",
                                "children": [
                                    { "size": 26241, "caption": "socket_stream.cc 26.2k" },
                                    { "size": 10126, "caption": "socket_stream_metrics.cc 10.1k" },
                                    { "size": 1369, "caption": "socket_stream_job_manager.cc 1.4k" },
                                    { "size": 203, "caption": "socket_stream_job.cc 203" }
                                ]
                            },
                            {
                                "size": 14994,
                                "caption": "ocsp 15.0k",
                                "children": [{ "size": 14994, "caption": "nss_ocsp.cc 15.0k" }]
                            },
                            {
                                "size": 8290,
                                "caption": "server 8.3k",
                                "children": [{ "size": 8290, "caption": "http_listen_socket.cc 8.3k" }]
                            }
                        ]
                    },
                    {
                        "size": 594545,
                        "caption": "/webkit 594.5k",
                        "children": [
                            {
                                "size": 381417,
                                "caption": "glue 381.4k",
                                "children": [
                                    {
                                        "size": 225852,
                                        "caption": "plugins 225.9k",
                                        "children": [
                                            { "size": 21117, "caption": "webplugin_impl.cc 21.1k" },
                                            { "size": 17803, "caption": "pepper_graphics_3d_gl.cc 17.8k" },
                                            { "size": 11040, "caption": "plugin_list.cc 11.0k" },
                                            {
                                                "size": 10946,
                                                "caption": "webplugin_delegate_impl_gtk.cc 10.9k"
                                            },
                                            { "size": 10803, "caption": "plugin_instance.cc 10.8k" },
                                            { "size": 9607, "caption": "pepper_var.cc 9.6k" },
                                            { "size": 9498, "caption": "pepper_device_context_2d.cc 9.5k" },
                                            { "size": 8602, "caption": "plugin_host.cc 8.6k" },
                                            { "size": 8569, "caption": "pepper_url_loader.cc 8.6k" },
                                            { "size": 8138, "caption": "plugin_lib.cc 8.1k" },
                                            { "size": 7904, "caption": "pepper_file_io.cc 7.9k" },
                                            { "size": 6646, "caption": "pepper_plugin_instance.cc 6.6k" },
                                            { "size": 6246, "caption": "pepper_url_request_info.cc 6.2k" },
                                            { "size": 5894, "caption": "webview_plugin.cc 5.9k" },
                                            { "size": 5513, "caption": "pepper_font.cc 5.5k" },
                                            { "size": 5460, "caption": "plugin_list_posix.cc 5.5k" },
                                            { "size": 5367, "caption": "pepper_plugin_module.cc 5.4k" },
                                            { "size": 4797, "caption": "pepper_scrollbar.cc 4.8k" },
                                            { "size": 4658, "caption": "pepper_graphics_3d.cc 4.7k" },
                                            { "size": 4555, "caption": "pepper_audio.cc 4.6k" },
                                            { "size": 4330, "caption": "pepper_file_ref.cc 4.3k" },
                                            { "size": 4329, "caption": "plugin_lib_posix.cc 4.3k" },
                                            { "size": 4264, "caption": "npapi_extension_thunk.cc 4.3k" },
                                            { "size": 3777, "caption": "pepper_webplugin_impl.cc 3.8k" },
                                            { "size": 3514, "caption": "pepper_widget.cc 3.5k" },
                                            { "size": 3438, "caption": "pepper_file_chooser.cc 3.4k" },
                                            { "size": 3237, "caption": "plugin_stream.cc 3.2k" },
                                            { "size": 3148, "caption": "pepper_url_response_info.cc 3.1k" },
                                            { "size": 2622, "caption": "pepper_image_data.cc 2.6k" },
                                            { "size": 2426, "caption": "pepper_url_util.cc 2.4k" },
                                            { "size": 2294, "caption": "pepper_buffer.cc 2.3k" },
                                            {
                                                "size": 2067,
                                                "caption": "gtk_plugin_container_manager.cc 2.1k"
                                            },
                                            { "size": 2013, "caption": "pepper_video_decoder.cc 2.0k" },
                                            { "size": 1937, "caption": "webplugin_delegate_impl.cc 1.9k" },
                                            { "size": 1783, "caption": "pepper_directory_reader.cc 1.8k" },
                                            { "size": 1209, "caption": "pepper_event_conversion.cc 1.2k" },
                                            { "size": 1204, "caption": "pepper_private.cc 1.2k" },
                                            { "size": 1132, "caption": "plugin_stream_url.cc 1.1k" },
                                            { "size": 952, "caption": "pepper_char_set.cc 952" },
                                            { "size": 785, "caption": "plugin_stream_posix.cc 785" },
                                            { "size": 780, "caption": "pepper_resource_tracker.cc 780" },
                                            { "size": 397, "caption": "gtk_plugin_container.cc 397" },
                                            { "size": 389, "caption": "plugin_string_stream.cc 389" },
                                            { "size": 352, "caption": "pepper_resource.cc 352" },
                                            { "size": 250, "caption": "webplugin.cc 250" },
                                            { "size": 60, "caption": "pepper_file_system.cc 60" }
                                        ]
                                    },
                                    {
                                        "size": 26266,
                                        "caption": "media 26.3k",
                                        "children": [
                                            { "size": 14791, "caption": "buffered_data_source.cc 14.8k" },
                                            { "size": 6214, "caption": "simple_data_source.cc 6.2k" },
                                            { "size": 4114, "caption": "video_renderer_impl.cc 4.1k" }, {
                                                "size": 1147,
                                                "caption": "media_resource_loader_bridge_factory.cc 1.1k"
                                            }
                                        ]
                                    },
                                    { "size": 16282, "caption": "dom_operations.cc 16.3k" },
                                    { "size": 14446, "caption": "weburlloader_impl.cc 14.4k" },
                                    { "size": 13432, "caption": "webmediaplayer_impl.cc 13.4k" },
                                    { "size": 9781, "caption": "site_isolation_metrics.cc 9.8k" },
                                    { "size": 7754, "caption": "glue_serialize.cc 7.8k" },
                                    { "size": 6401, "caption": "webclipboard_impl.cc 6.4k" },
                                    { "size": 5364, "caption": "multipart_response_delegate.cc 5.4k" },
                                    { "size": 5142, "caption": "password_form_dom_manager.cc 5.1k" },
                                    {
                                        "size": 5115,
                                        "caption": "webpasswordautocompletelistener_impl.cc 5.1k"
                                    },
                                    { "size": 4879, "caption": "webaccessibility.cc 4.9k" },
                                    { "size": 4354, "caption": "webkitclient_impl.cc 4.4k" },
                                    { "size": 3745, "caption": "webkit_glue.cc 3.7k" },
                                    {
                                        "size": 2970,
                                        "caption": "ftp_directory_listing_response_delegate.cc 3.0k"
                                    },
                                    { "size": 2922, "caption": "simple_webmimeregistry_impl.cc 2.9k" },
                                    { "size": 2719, "caption": "webfileutilities_impl.cc 2.7k" },
                                    { "size": 2619, "caption": "resource_fetcher.cc 2.6k" },
                                    { "size": 2612, "caption": "cpp_bound_class.cc 2.6k" },
                                    { "size": 2483, "caption": "websocketstreamhandle_impl.cc 2.5k" },
                                    { "size": 2409, "caption": "webpreferences.cc 2.4k" },
                                    { "size": 2334, "caption": "resource_loader_bridge.cc 2.3k" },
                                    { "size": 2267, "caption": "webdropdata.cc 2.3k" },
                                    { "size": 1778, "caption": "webcursor.cc 1.8k" },
                                    { "size": 1752, "caption": "cpp_variant.cc 1.8k" },
                                    { "size": 1669, "caption": "webcursor_gtk.cc 1.7k" },
                                    { "size": 1438, "caption": "npruntime_util.cc 1.4k" },
                                    { "size": 716, "caption": "image_resource_fetcher.cc 716" },
                                    { "size": 633, "caption": "idb_bindings.cc 633" },
                                    { "size": 503, "caption": "alt_error_page_resource_fetcher.cc 503" },
                                    { "size": 362, "caption": "form_field.cc 362" },
                                    { "size": 226, "caption": "window_open_disposition.cc 226" },
                                    { "size": 192, "caption": "image_decoder.cc 192" }
                                ]
                            },
                            {
                                "size": 179792,
                                "caption": "appcache 179.8k",
                                "children": [
                                    { "size": 36649, "caption": "appcache_update_job.cc 36.6k" },
                                    { "size": 33386, "caption": "appcache_storage_impl.cc 33.4k" },
                                    { "size": 19439, "caption": "appcache_database.cc 19.4k" },
                                    { "size": 13723, "caption": "appcache_host.cc 13.7k" },
                                    {
                                        "size": 8902,
                                        "caption": "web_application_cache_host_impl.cc 8.9k"
                                    },
                                    { "size": 8150, "caption": "appcache_group.cc 8.2k" },
                                    { "size": 8110, "caption": "appcache.cc 8.1k" },
                                    { "size": 7901, "caption": "appcache_url_request_job.cc 7.9k" },
                                    { "size": 7394, "caption": "appcache_request_handler.cc 7.4k" },
                                    { "size": 6995, "caption": "appcache_response.cc 7.0k" },
                                    { "size": 5761, "caption": "appcache_storage.cc 5.8k" },
                                    { "size": 5346, "caption": "view_appcache_internals_job.cc 5.3k" },
                                    { "size": 4349, "caption": "manifest_parser.cc 4.3k" },
                                    { "size": 3533, "caption": "appcache_working_set.cc 3.5k" },
                                    { "size": 3420, "caption": "appcache_service.cc 3.4k" },
                                    { "size": 2073, "caption": "appcache_disk_cache.cc 2.1k" },
                                    { "size": 1540, "caption": "appcache_backend_impl.cc 1.5k" },
                                    { "size": 1330, "caption": "appcache_histograms.cc 1.3k" },
                                    { "size": 1024, "caption": "appcache_interceptor.cc 1.0k" },
                                    { "size": 594, "caption": "appcache_frontend_impl.cc 594" },
                                    { "size": 173, "caption": "appcache_interfaces.cc 173" }
                                ]
                            },
                            {
                                "size": 33120,
                                "caption": "database 33.1k",
                                "children": [
                                    { "size": 21825, "caption": "database_tracker.cc 21.8k" },
                                    { "size": 4961, "caption": "databases_table.cc 5.0k" },
                                    { "size": 3189, "caption": "database_connections.cc 3.2k" },
                                    { "size": 1729, "caption": "database_util.cc 1.7k" },
                                    { "size": 1039, "caption": "vfs_backend.cc 1.0k" },
                                    { "size": 377, "caption": "quota_table.cc 377" }
                                ]
                            },
                            {
                                "size": 216,
                                "caption": "extensions 216",
                                "children": [{
                                        "size": 216,
                                        "caption": "v8 216",
                                        "children": [
                                            { "size": 74, "caption": "interval_extension.cc 74" },
                                            { "size": 74, "caption": "benchmarking_extension.cc 74" },
                                            { "size": 68, "caption": "playback_extension.cc 68" }
                                        ]
                                    }]
                            }
                        ]
                    },
                    {
                        ...
                        "caption": "/base 529.3k",
                        "children": [
                            { "size": 180328, "caption": "logging.h 180.3k" },
                            {
                                "size": 50514,
                                "caption": "third_party 50.5k",
                                "children": [
                                    {
                                        "size": 14872,
                                        "caption": "dmg_fp 14.9k",
                                        "children": [
                                            { "size": 14308, "caption": "dtoa.cc 14.3k" },
                                            { "size": 564, "caption": "g_fmt.cc 564" }
                                        ]
                                    },
                                    {
                                        "size": 12977,
                                        "caption": "xdg_mime 13.0k",
                                        "children": [
                                            { "size": 3083, "caption": "xdgmime.c 3.1k" },
                                            { "size": 2688, "caption": "xdgmimecache.c 2.7k" },
                                            { "size": 2670, "caption": "xdgmimemagic.c 2.7k" },
                                            { "size": 1902, "caption": "xdgmimeglob.c 1.9k" },
                                            { "size": 1006, "caption": "xdgmimeparent.c 1.0k" },
                                            { "size": 655, "caption": "xdgmimeicon.c 655" },
                                            { "size": 655, "caption": "xdgmimealias.c 655" },
                                            { "size": 318, "caption": "xdgmimeint.c 318" }
                                        ]
                                    },
                                    {
                                        "size": 9721,
                                        "caption": "symbolize 9.7k",
                                        "children": [
                                            { "size": 6951, "caption": "demangle.cc 7.0k" },
                                            { "size": 2770, "caption": "symbolize.cc 2.8k" }
                                        ]
                                    },
                                    {
                                        "size": 8422,
                                        "caption": "nspr 8.4k",
                                        "children": [{ "size": 8422, "caption": "prtime.cc 8.4k" }]
                                    },
                                    {
                                        "size": 2564,
                                        "caption": "nss 2.6k",
                                        "children": [{ "size": 2564, "caption": "sha512.cc 2.6k" }]
                                    },
                                    {
                                        "size": 1307,
                                        "caption": "xdg_user_dirs 1.3k",
                                        "children": [{ "size": 1307, "caption": "xdg_user_dir_lookup.cc 1.3k" }]
                                    },
                                    {
                                        "size": 571,
                                        "caption": "icu 571",
                                        "children": [{ "size": 571, "caption": "icu_utf.cc 571" }]
                                    },
                                    {
                                        "size": 80,
                                        "caption": "dynamic_annotations 80",
                                        "children": [{ "size": 80, "caption": "dynamic_annotations.c 80" }]
                                    }
                                ]
                            },
                            { "size": 21973, "caption": "histogram.cc 22.0k" },
                            { "size": 19212, "caption": "mime_util_xdg.cc 19.2k" },
                            { "size": 16631, "caption": "file_util_posix.cc 16.6k" },
                            { "size": 16268, "caption": "message_loop.cc 16.3k" },
                            { "size": 14021, "caption": "values.cc 14.0k" },
                            { "size": 13906, "caption": "process_util_linux.cc 13.9k" },
                            { "size": 13262, "caption": "string_util.cc 13.3k" },
                            {
                                "size": 11984,
                                "caption": "json 12.0k",
                                "children": [
                                    { "size": 7742, "caption": "json_reader.cc 7.7k" },
                                    { "size": 2887, "caption": "json_writer.cc 2.9k" },
                                    { "size": 1355, "caption": "string_escape.cc 1.4k" }
                                ]
                            },
                            { "size": 9721, "caption": "task.h 9.7k" },
                            {
                                "size": 9348,
                                "caption": "i18n 9.3k",
                                "children": [
                                    { "size": 2573, "caption": "rtl.cc 2.6k" },
                                    { "size": 2181, "caption": "file_util_icu.cc 2.2k" },
                                    { "size": 2040, "caption": "icu_string_conversions.cc 2.0k" },
                                    { "size": 793, "caption": "time_formatting.cc 793" },
                                    { "size": 723, "caption": "word_iterator.cc 723" },
                                    { "size": 535, "caption": "number_formatting.cc 535" },
                                    { "size": 295, "caption": "icu_encoding_detection.cc 295" },
                                    { "size": 208, "caption": "icu_util.cc 208" }
                                ]
                            },
                            {
                                "size": 8678,
                                "caption": "crypto 8.7k",
                                "children": [
                                    { "size": 2476, "caption": "rsa_private_key.cc 2.5k" },
                                    { "size": 2205, "caption": "encryptor_nss.cc 2.2k" },
                                    { "size": 1768, "caption": "rsa_private_key_nss.cc 1.8k" },
                                    { "size": 816, "caption": "signature_verifier_nss.cc 816" },
                                    { "size": 747, "caption": "symmetric_key_nss.cc 747" },
                                    { "size": 666, "caption": "signature_creator_nss.cc 666" }
                                ]
                            },
                            { "size": 8200, "caption": "command_line.cc 8.2k" },
                            { "size": 6725, "caption": "process_util_posix.cc 6.7k" },
                            { "size": 6694, "caption": "file_path.cc 6.7k" },
                            { "size": 5622, "caption": "logging.cc 5.6k" },
                            { "size": 5582, "caption": "pickle.cc 5.6k" },
                            { "size": 5398, "caption": "message_pump_libevent.cc 5.4k" },
                            { "size": 4810, "caption": "singleton.h 4.8k" },
                            { "size": 4684, "caption": "string_number_conversions.cc 4.7k" },
                            { "size": 4649, "caption": "field_trial.cc 4.6k" },
                            { "size": 4321, "caption": "stats_table.cc 4.3k" },
                            { "size": 3747, "caption": "waitable_event_posix.cc 3.7k" },
                            { "size": 3685, "caption": "shared_memory_posix.cc 3.7k" },
                            { "size": 3449, "caption": "keyboard_code_conversion_gtk.cc 3.4k" },
                            { "size": 3183, "caption": "md5.cc 3.2k" },
                            { "size": 3041, "caption": "message_pump_glib.cc 3.0k" },
                            { "size": 2992, "caption": "thread.cc 3.0k" },
                            { "size": 2978, "caption": "string_split.cc 3.0k" },
                            { "size": 2796, "caption": "utf_string_conversions.cc 2.8k" },
                            { "size": 2765, "caption": "worker_pool_linux.cc 2.8k" },
                            { "size": 2694, "caption": "path_service.cc 2.7k" },
                            { "size": 2482, "caption": "file_util_proxy.cc 2.5k" },
                            { "size": 2443, "caption": "nss_util.cc 2.4k" },
                            { "size": 2240, "caption": "simple_thread.cc 2.2k" },
                            { "size": 2171, "caption": "watchdog.cc 2.2k" },
                            { "size": 2027, "caption": "at_exit.cc 2.0k" },
                            { "size": 1950, "caption": "base_paths_posix.cc 1.9k" },
                            { "size": 1929, "caption": "version.cc 1.9k" },
                            { "size": 1838, "caption": "waitable_event_watcher_posix.cc 1.8k" },
                            { "size": 1731, "caption": "data_pack.cc 1.7k" },
                            { "size": 1699, "caption": "file_util.cc 1.7k" },
                            { "size": 1386, "caption": "stringprintf.cc 1.4k" },
                            { "size": 1371, "caption": "hmac_nss.cc 1.4k" },
                            { "size": 1354, "caption": "string_piece.cc 1.4k" },
                            { "size": 1304, "caption": "time.cc 1.3k" },
                            { "size": 1297, "caption": "unix_domain_socket_posix.cc 1.3k" },
                            { "size": 1272, "caption": "message_loop_proxy_impl.cc 1.3k" },
                            { "size": 1194, "caption": "debug_util_posix.cc 1.2k" },
                            { "size": 1157, "caption": "event_synthesis_gtk.cc 1.2k" },
                            { "size": 1096, "caption": "condition_variable_posix.cc 1.1k" },
                            { "size": 1074, "caption": "file_descriptor_shuffle.cc 1.1k" },
                            { "size": 1030, "caption": "utf_offset_string_conversions.cc 1.0k" },
                            { "size": 1023, "caption": "environment.cc 1.0k" },
                            { "size": 982, "caption": "xdg_util.cc 982" },
                            { "size": 959, "caption": "sha1_portable.cc 959" },
                            { "size": 949, "caption": "time_posix.cc 949" },
                            { "size": 936, "caption": "utf_string_conversion_utils.cc 936" },
                            { "size": 925, "caption": "sys_info_posix.cc 925" },
                            { "size": 824, "caption": "sys_string_conversions_linux.cc 824" },
                            { "size": 800, "caption": "timer.h 800" },
                            { "size": 746, "caption": "platform_file_posix.cc 746" },
                            { "size": 662, "caption": "callback.h 662" },
                            { "size": 646, "caption": "native_library_linux.cc 646" },
                            { "size": 646, "caption": "thread_local_storage_posix.cc 646" },
                            { "size": 632, "caption": "rand_util_posix.cc 632" },
                            { "size": 629, "caption": "gtk_util.cc 629" },
                            { "size": 541, "caption": "rand_util.cc 541" },
                            { "size": 520, "caption": "scoped_temp_dir.cc 520" },
                            { "size": 516, "caption": "message_pump_default.cc 516" },
                            { "size": 507, "caption": "process_linux.cc 507" },
                            { "size": 503, "caption": "sync_socket_posix.cc 503" },
                            { "size": 497, "caption": "setproctitle_linux.c 497" },
                            { "size": 490, "caption": "tracked.cc 490" },
                            { "size": 457, "caption": "base64.cc 457" },
                            { "size": 448, "caption": "sys_info_linux.cc 448" },
                            { "size": 426, "caption": "id_map.h 426" },
                            { "size": 412, "caption": "platform_thread_posix.cc 412" },
                            { "size": 410, "caption": "ref_counted.h 410" },
                            { "size": 399, "caption": "lock_impl_posix.cc 399" },
                            { "size": 381, "caption": "thread_local_posix.cc 381" },
                            { "size": 352, "caption": "weak_ptr.cc 352" },
                            { "size": 351, "caption": "file_util_linux.cc 351" },
                            { "size": 335, "caption": "ref_counted_memory.cc 335" },
                            { "size": 302, "caption": "global_descriptors_posix.cc 302" },
                            { "size": 281, "caption": "lazy_instance.h 281" },
                            { "size": 272, "caption": "string16.cc 272" },
                            { "size": 230, "caption": "task.cc 230" },
                            { "size": 225, "caption": "process_posix.cc 225" },
                            { "size": 185, "caption": "safe_strerror_posix.cc 185" },
                            { "size": 183, "caption": "linux_util.cc 183" },
                            { "size": 169, "caption": "base_paths.cc 169" },
                            { "size": 129, "caption": "timer.cc 129" },
                            { "size": 121, "caption": "ref_counted.cc 121" },
                            { "size": 119, "caption": "sha2.cc 119" },
                            { "size": 103, "caption": "lazy_instance.cc 103" },
                            { "size": 96, "caption": "debug_util.cc 96" },
                            { "size": 45, "caption": "scoped_ptr.h 45" },
                            { "size": 29, "caption": "cancellation_flag.cc 29" },
                            { "size": 17, "caption": "event_recorder_stubs.cc 17" }
                        ]
                    },
                    {
                        "size": 199179,
                        "caption": "/native_client 199.2k",
                        "children": [{
                                "size": 199179,
                                "caption": "src 199.2k",
                                "children": [
                                    {
                                        "size": 151176,
                                        "caption": "trusted 151.2k",
                                        "children": [
                                            {
                                                "size": 77066,
                                                "caption": "plugin 77.1k",
                                                "children": [
                                                    {
                                                        "size": 34556,
                                                        "caption": "npapi 34.6k",
                                                        "children": [
                                                            { "size": 10809, "caption": "closure.cc 10.8k" },
                                                            { "size": 8018, "caption": "plugin_npapi.cc 8.0k" }, {
                                                                "size": 7537,
                                                                "caption": "scriptable_impl_npapi.cc 7.5k"
                                                            },
                                                            { "size": 3971, "caption": "multimedia_socket.cc 4.0k" },
                                                            { "size": 1523, "caption": "browser_impl_npapi.cc 1.5k" },
                                                            { "size": 1187, "caption": "npp_launcher.cc 1.2k" },
                                                            { "size": 548, "caption": "npapi_native.cc 548" },
                                                            { "size": 472, "caption": "ret_array.cc 472" },
                                                            { "size": 418, "caption": "async_receive.cc 418" },
                                                            { "size": 58, "caption": "video_chrome.cc 58" },
                                                            { "size": 15, "caption": "npp_gate.cc 15" }
                                                        ]
                                                    },
                                                    { "size": 10338, "caption": "plugin.cc 10.3k" },
                                                    { "size": 6357, "caption": "service_runtime.cc 6.4k" },
                                                    { "size": 3556, "caption": "srpc_client.cc 3.6k" },
                                                    { "size": 2266, "caption": "portable_handle.cc 2.3k" },
                                                    { "size": 2256, "caption": "srt_socket.cc 2.3k" },
                                                    { "size": 2230, "caption": "shared_memory.cc 2.2k" },
                                                    { "size": 2190, "caption": "scriptable_handle.cc 2.2k" },
                                                    { "size": 2163, "caption": "browser_interface.cc 2.2k" },
                                                    { "size": 2033, "caption": "nexe_arch.cc 2.0k" },
                                                    { "size": 1492, "caption": "origin.cc 1.5k" },
                                                    { "size": 1492, "caption": "connected_socket.cc 1.5k" },
                                                    { "size": 1259, "caption": "desc_based_handle.cc 1.3k" },
                                                    { "size": 1251, "caption": "socket_address.cc 1.3k" },
                                                    { "size": 1131, "caption": "nacl_entry_points.cc 1.1k" },
                                                    { "size": 1106, "caption": "method_map.cc 1.1k" },
                                                    { "size": 825, "caption": "stream_shm_buffer.cc 825" },
                                                    { "size": 399, "caption": "string_encoding.cc 399" },
                                                    { "size": 166, "caption": "utility.cc 166" }
                                                ]
                                            },
                                            {
                                                "size": 45491,
                                                "caption": "service_runtime 45.5k",
                                                "children": [
                                                    { "size": 13780, "caption": "nacl_syscall_common.c 13.8k" },
                                                    { "size": 3730, "caption": "sel_ldr.c 3.7k" },
                                                    { "size": 3453, "caption": "elf_util.c 3.5k" },
                                                    { "size": 3139, "caption": "sel_ldr_standard.c 3.1k" },
                                                    { "size": 2376, "caption": "gio_shm.c 2.4k" },
                                                    { "size": 2330, "caption": "nacl_text.c 2.3k" },
                                                    {
                                                        "size": 2320,
                                                        "caption": "arch 2.3k",
                                                        "children": [
                                                            {
                                                                ...
                                                                "caption": "x86_32 2.2k",
                                                                "children": [
                                                                    { "size": 716, "caption": "nacl_app_32.c 716" },
                                                                    { "size": 445, "caption": "sel_rt_32.c 445" }, {
                                                                        "size": 385,
                                                                        "caption": "sel_addrspace_x86_32.c 385"
                                                                    },
                                                                    { "size": 284, "caption": "sel_ldr_x86_32.c 284" }, {
                                                                        "size": 216,
                                                                        "caption": "nacl_switch_to_app_32.c 216"
                                                                    },
                                                                    { "size": 178, "caption": "nacl_tls_32.c 178" }
                                                                ]
                                                            },
                                                            {
                                                                "size": 96,
                                                                "caption": "x86 96",
                                                                "children": [{ "size": 96, "caption": "nacl_ldt_x86.c 96" }]
                                                            }
                                                        ]
                                                    },
                                                    { "size": 2316, "caption": "sel_mem.c 2.3k" },
                                                    {
                                                        "size": 2170,
                                                        "caption": "linux 2.2k",
                                                        "children": [
                                                            { "size": 904, "caption": "nacl_signal.c 904" }, {
                                                                "size": 718,
                                                                "caption": "x86 718",
                                                                "children": [
                                                                    { "size": 645, "caption": "nacl_ldt.c 645" },
                                                                    { "size": 73, "caption": "sel_segments.c 73" }
                                                                ]
                                                            },
                                                            { "size": 282, "caption": "sel_memory.c 282" },
                                                            { "size": 266, "caption": "nacl_thread_nice.c 266" }
                                                        ]
                                                    },
                                                    { "size": 1909, "caption": "gio_shm_unbounded.c 1.9k" },
                                                    { "size": 1820, "caption": "sel_addrspace.c 1.8k" },
                                                    { "size": 1029, "caption": "nacl_app_thread.c 1.0k" },
                                                    { "size": 892, "caption": "nacl_syscall_hook.c 892" },
                                                    { "size": 863, "caption": "dyn_array.c 863" },
                                                    { "size": 805, "caption": "nacl_debug.cc 805" },
                                                    { "size": 647, "caption": "nacl_memory_object.c 647" },
                                                    { "size": 557, "caption": "sel_main_chrome.c 557" },
                                                    { "size": 473, "caption": "nacl_sync_queue.c 473" },
                                                    { "size": 417, "caption": "sel_validate_image.c 417" },
                                                    { "size": 118, "caption": "nacl_desc_effector_ldr.c 118" },
                                                    { "size": 118, "caption": "nacl_bottom_half.c 118" },
                                                    { "size": 83, "caption": "nacl_globals.c 83" },
                                                    { "size": 75, "caption": "sel_ldr-inl.h 75" },
                                                    { "size": 64, "caption": "nacl_all_modules.c 64" },
                                                    { "size": 7, "caption": "expiration.c 7" }
                                                ]
                                            },
                                            {
                                                "size": 18013,
                                                "caption": "desc 18.0k",
                                                "children": [
                                                    { "size": 3294, "caption": "nrd_xfer.c 3.3k" },
                                                    { "size": 2663, "caption": "nacl_desc_wrapper.cc 2.7k" },
                                                    { "size": 2433, "caption": "nacl_desc_base.c 2.4k" }, {
                                                        "size": 1842,
                                                        "caption": "linux 1.8k",
                                                        "children": [
                                                            { "size": 1399, "caption": "nacl_desc_sysv_shm.c 1.4k" },
                                                            { "size": 443, "caption": "nacl_desc.c 443" }
                                                        ]
                                                    },
                                                    { "size": 1588, "caption": "nacl_desc_imc_shm.c 1.6k" }, {
                                                        "size": 1332,
                                                        "caption": "posix 1.3k",
                                                        "children": [
                                                            { "size": 589, "caption": "nacl_desc_conn_cap.c 589" }, {
                                                                "size": 508,
                                                                "caption": "nacl_desc_imc_bound_desc.c 508"
                                                            },
                                                            { "size": 235, "caption": "nacl_makeboundsock.c 235" }
                                                        ]
                                                    },
                                                    { "size": 1159, "caption": "nacl_desc_io.c 1.2k" },
                                                    { "size": 1116, "caption": "nacl_desc_imc.c 1.1k" },
                                                    { "size": 511, "caption": "nacl_desc_sync_socket.c 511" },
                                                    { "size": 489, "caption": "nacl_desc_dir.c 489" },
                                                    { "size": 421, "caption": "nacl_desc_cond.c 421" },
                                                    { "size": 347, "caption": "nacl_desc_invalid.c 347" },
                                                    { "size": 324, "caption": "nacl_desc_mutex.c 324" },
                                                    { "size": 299, "caption": "nacl_desc_semaphore.c 299" }, {
                                                        "size": 93,
                                                        "caption": "nacl_desc_effector_trusted_mem.c 93"
                                                    },
                                                    { "size": 64, "caption": "nrd_all_modules.c 64" },
                                                    { "size": 38, "caption": "nrd_xfer_effector.c 38" }
                                                ]
                                            },
                                            {
                                                "size": 5377,
                                                "caption": "validator_x86 5.4k",
                                                "children": [
                                                    { "size": 2852, "caption": "ncvalidate.c 2.9k" },
                                                    { "size": 1813, "caption": "ncdecode.c 1.8k" },
                                                    { "size": 712, "caption": "nacl_cpuid.c 712" }
                                                ]
                                            },
                                            {
                                                "size": 3723,
                                                "caption": "nonnacl_util 3.7k",
                                                "children": [
                                                    {
                                                        "size": 2270,
                                                        "caption": "linux 2.3k",
                                                        "children": [
                                                            {
                                                                "size": 2093,
                                                                "caption": "sel_ldr_launcher_linux.cc 2.1k"
                                                            },
                                                            { "size": 177, "caption": "get_plugin_dirname.cc 177" }
                                                        ]
                                                    },
                                                    { "size": 1362, "caption": "sel_ldr_launcher.cc 1.4k" },
                                                    { "size": 91, "caption": "sel_ldr_launcher_chrome.cc 91" }
                                                ]
                                            },
                                            {
                                                "size": 1506,
                                                "caption": "platform_qualify 1.5k",
                                                "children": [{
                                                        "size": 1506,
                                                        "caption": "linux 1.5k",
                                                        "children": [
                                                            { "size": 1478, "caption": "sysv_shm_and_mmap.c 1.5k" },
                                                            { "size": 28, "caption": "nacl_os_qualify.c 28" }
                                                        ]
                                                    }]
                                            }
                                        ]
                                    ...
                                    {
                                        "size": 47148,
                                        "caption": "shared 47.1k",
                                        "children": [
                                            {
                                                "size": 22474,
                                                "caption": "npruntime 22.5k",
                                                "children": [
                                                    { "size": 4646, "caption": "npmodule.cc 4.6k" },
                                                    { "size": 4039, "caption": "npobject_proxy.cc 4.0k" },
                                                    { "size": 3717, "caption": "naclnp_util.cc 3.7k" },
                                                    { "size": 2520, "caption": "npmodule_rpc_impl.cc 2.5k" },
                                                    { "size": 2041, "caption": "npobject_stub.cc 2.0k" },
                                                    { "size": 1840, "caption": "structure_translations.cc 1.8k" },
                                                    { "size": 1768, "caption": "npstub_rpc_impl.cc 1.8k" },
                                                    { "size": 1041, "caption": "npbridge.cc 1.0k" },
                                                    { "size": 584, "caption": "npupcall_server.cc 584" },
                                                    { "size": 278, "caption": "pointer_translations.cc 278" }
                                                ]
                                            },
                                            {
                                                "size": 15251,
                                                "caption": "srpc 15.3k",
                                                "children": [
                                                    { "size": 8922, "caption": "rpc_serialize.c 8.9k" },
                                                    { "size": 2136, "caption": "invoke.c 2.1k" },
                                                    { "size": 1882, "caption": "rpc_service.c 1.9k" },
                                                    { "size": 1177, "caption": "imc_buffer.c 1.2k" },
                                                    { "size": 833, "caption": "nacl_srpc.c 833" },
                                                    { "size": 185, "caption": "rpc_server_loop.c 185" },
                                                    { "size": 116, "caption": "utility.c 116" }
                                                ]
                                            },
                                            {
                                                "size": 7486,
                                                "caption": "platform 7.5k",
                                                "children": [
                                                    {
                                                        "size": 4564,
                                                        "caption": "linux 4.6k",
                                                        "children": [
                                                            { "size": 1823, "caption": "nacl_host_desc.c 1.8k" },
                                                            { "size": 658, "caption": "nacl_threads.c 658" },
                                                            { "size": 552, "caption": "nacl_host_dir.c 552" },
                                                            { "size": 380, "caption": "nacl_time.c 380" },
                                                            { "size": 246, "caption": "nacl_secure_random.c 246" },
                                                            { "size": 199, "caption": "time_linux.cc 199" },
                                                            { "size": 199, "caption": "condition_variable.cc 199" },
                                                            { "size": 174, "caption": "nacl_timestamp.c 174" },
                                                            { "size": 139, "caption": "nacl_find_addrsp.c 139" },
                                                            { "size": 131, "caption": "nacl_semaphore.c 131" },
                                                            { "size": 63, "caption": "lock.cc 63" }
                                                        ]
                                                    },
                                                    { "size": 1111, "caption": "nacl_log.c 1.1k" },
                                                    { "size": 464, "caption": "nacl_sync.cc 464" },
                                                    { "size": 382, "caption": "nacl_interruptible_mutex.c 382" },
                                                    { "size": 252, "caption": "nacl_sync_checked.c 252" },
                                                    { "size": 233, "caption": "nacl_interruptible_condvar.c 233" },
                                                    { "size": 209, "caption": "nacl_secure_random_common.c 209" },
                                                    { "size": 91, "caption": "nacl_global_secure_random.c 91" },
                                                    { "size": 88, "caption": "nacl_host_desc_common.c 88" },
                                                    { "size": 58, "caption": "time.cc 58" },
                                                    { "size": 34, "caption": "nacl_check.c 34" }
                                                ]
                                            },
                                            {
                                                "size": 1365,
                                                ...
                                                "children": [
                                                    {
                                                        "size": 792,
                                                        "caption": "linux 792",
                                                        "children": [{ "size": 792, "caption": "nacl_imc.cc 792" }]
                                                    },
                                                    { "size": 408, "caption": "nacl_imc_unistd.cc 408" },
                                                    { "size": 100, "caption": "nacl_imc_c.cc 100" },
                                                    { "size": 65, "caption": "nacl_imc_common.cc 65" }
                                                ]
                                            },
                                            {
                                                "size": 572,
                                                "caption": "gio 572",
                                                "children": [
                                                    { "size": 368, "caption": "gio.c 368" },
                                                    { "size": 204, "caption": "gprintf.c 204" }
                                                ]
                                            }
                                        ]
                                    },
                                    {
                                        "size": 855,
                                        "caption": "third_party_mod 855",
                                        "children": [{
                                                "size": 855,
                                                "caption": "npapi_plugin 855",
                                                "children": [
                                                    { "size": 575, "caption": "np_entry.cc 575" },
                                                    { "size": 280, "caption": "npn_gate.cc 280" }
                                                ]
                                            }]
                                    }
                                ]
                    ...
                    },
                    {
                        ...
                        "children": [
                            {
                                "size": 182902,
                                "caption": "command_buffer 182.9k",
                                "children": [
                                    {
                                        "size": 135748,
                                        "caption": "service 135.7k",
                                        "children": [
                                            { "size": 58718, "caption": "gles2_cmd_decoder.cc 58.7k" },
                                            { "size": 27182, "caption": "gles2_cmd_decoder_autogen.h 27.2k" },
                                            { "size": 11852, "caption": "program_manager.cc 11.9k" },
                                            { "size": 8921, "caption": "texture_manager.cc 8.9k" },
                                            { "size": 7914, "caption": "context_group.cc 7.9k" }, {
                                                "size": 4703,
                                                "caption": "gles2_cmd_validation_implementation_autogen.h 4.7k"
                                            },
                                            { "size": 3055, "caption": "buffer_manager.cc 3.1k" },
                                            { "size": 2926, "caption": "command_buffer_service.cc 2.9k" },
                                            { "size": 2774, "caption": "common_decoder.cc 2.8k" },
                                            { "size": 1922, "caption": "shader_manager.cc 1.9k" },
                                            { "size": 1871, "caption": "framebuffer_manager.cc 1.9k" },
                                            { "size": 1666, "caption": "gpu_processor.cc 1.7k" },
                                            { "size": 1088, "caption": "renderbuffer_manager.cc 1.1k" },
                                            { "size": 776, "caption": "cmd_parser.cc 776" },
                                            { "size": 380, "caption": "gpu_processor_linux.cc 380" }
                                        ]
                                    },
                                    {
                                        "size": 43609,
                                        "caption": "client 43.6k",
                                        "children": [
                                            { "size": 18738, "caption": "gles2_implementation.cc 18.7k" },
                                            { "size": 16527, "caption": "gles2_c_lib_autogen.h 16.5k" },
                                            { "size": 2790, "caption": "fenced_allocator.cc 2.8k" },
                                            { "size": 2567, "caption": "ring_buffer.cc 2.6k" },
                                            { "size": 1443, "caption": "mapped_memory.cc 1.4k" },
                                            { "size": 1429, "caption": "cmd_buffer_helper.cc 1.4k" },
                                            { "size": 115, "caption": "gles2_lib.cc 115" }
                                        ]
                                    },
                                    {
                                        "size": 3545,
                                        "caption": "common 3.5k",
                                        "children": [
                                            { "size": 2066, "caption": "gles2_cmd_utils.cc 2.1k" },
                                            { "size": 1420, "caption": "id_allocator.cc 1.4k" },
                                            { "size": 34, "caption": "gles2_cmd_format.cc 34" },
                                            { "size": 25, "caption": "cmd_buffer_common.cc 25" }
                                        ]
                                    }
                                ]
                            },
                            {
                                "size": 155,
                                "caption": "gpu_plugin 155",
                                "children": [{ "size": 155, "caption": "gpu_plugin.cc 155" }]
                            }
                        ]
                    },
                    {
                        "size": 126871,
                        "caption": "/media 126.9k",
                        "children": [
                            {
                                "size": 65899,
                                "caption": "filters 65.9k",
                                "children": [
                                    { "size": 15973, "caption": "ffmpeg_demuxer.cc 16.0k" },
                                    { "size": 14093, "caption": "video_renderer_base.cc 14.1k" },
                                    { "size": 9845, "caption": "ffmpeg_video_decoder.cc 9.8k" },
                                    { "size": 5325, "caption": "ffmpeg_audio_decoder.cc 5.3k" },
                                    { "size": 5286, "caption": "audio_renderer_base.cc 5.3k" },
                                    { "size": 5150, "caption": "ffmpeg_video_decode_engine.cc 5.2k" },
                                    { "size": 3215, "caption": "audio_renderer_algorithm_ola.cc 3.2k" },
                                    { "size": 3167, "caption": "audio_renderer_algorithm_base.cc 3.2k" },
                                    { "size": 2017, "caption": "ffmpeg_glue.cc 2.0k" },
                                    { "size": 1009, "caption": "null_audio_renderer.cc 1.0k" },
                                    { "size": 743, "caption": "bitstream_converter.cc 743" },
                                    { "size": 76, "caption": "ffmpeg_interfaces.cc 76" }
                                ]
                            },
                            {
                                "size": 32527,
                                "caption": "base 32.5k",
                                "children": [
                                    { "size": 21508, "caption": "pipeline_impl.cc 21.5k" },
                                    { "size": 2645, "caption": "seekable_buffer.cc 2.6k" },
                                    { "size": 2146, "caption": "video_frame.cc 2.1k" },
                                    { "size": 1808, "caption": "media_posix.cc 1.8k" },
                                    { "size": 1565, "caption": "yuv_convert.cc 1.6k" },
                                    { "size": 1323, "caption": "media_format.cc 1.3k" },
                                    { "size": 941, "caption": "clock_impl.cc 941" },
                                    { "size": 591, "caption": "data_buffer.cc 591" }
                                ]
                            },
                            {
                                "size": 28367,
                                ...
                                "children": [
                                    {
                                        ...
                                        "caption": "linux 15.2k",
                                        "children": [
                                            { "size": 12897, "caption": "alsa_output.cc 12.9k" },
                                            { "size": 1863, "caption": "audio_manager_linux.cc 1.9k" },
                                            { "size": 468, "caption": "alsa_wrapper.cc 468" }
                                        ]
                                    },
                                    { "size": 5804, "caption": "audio_output_controller.cc 5.8k" },
                                    { "size": 2477, "caption": "audio_input_controller.cc 2.5k" },
                                    { "size": 2166, "caption": "audio_util.cc 2.2k" },
                                    { "size": 1255, "caption": "fake_audio_input_stream.cc 1.3k" },
                                    { "size": 620, "caption": "fake_audio_output_stream.cc 620" },
                                    { "size": 514, "caption": "simple_sources.cc 514" },
                                    { "size": 206, "caption": "audio_manager_base.cc 206" },
                                    { "size": 97, "caption": "audio_manager.cc 97" }
                                ]
                            },
                            {
                                "size": 78,
                                "caption": "ffmpeg 78",
                                "children": [{ "size": 78, "caption": "ffmpeg_util.cc 78" }]
                            }
                        ]
                    },
                    {
                        "size": 124682,
                        "caption": "/jingle 124.7k",
                        "children": [{
                                "size": 124682,
                                "caption": "notifier 124.7k",
                                "children": [
                                    {
                                        "size": 73116,
                                        "caption": "communicator 73.1k",
                                        "children": [
                                            { "size": 14485, "caption": "xmpp_connection_generator.cc 14.5k" },
                                            { "size": 12767, "caption": "xmpp_socket_adapter.cc 12.8k" },
                                            { "size": 12158, "caption": "single_login_attempt.cc 12.2k" },
                                            { "size": 11623, "caption": "login.cc 11.6k" },
                                            { "size": 8764, "caption": "connection_settings.cc 8.8k" },
                                            { "size": 6191, "caption": "ssl_socket_adapter.cc 6.2k" },
                                            { "size": 4660, "caption": "gaia_token_pre_xmpp_auth.cc 4.7k" },
                                            { "size": 2304, "caption": "login_settings.cc 2.3k" },
                                            { "size": 69, "caption": "connection_options.cc 69" },
                                            { "size": 52, "caption": "login_failure.cc 52" },
                                            { "size": 43, "caption": "product_info.cc 43" }
                                        ]
                                    },
                                    {
                                        "size": 37546,
                                        "caption": "listener 37.5k",
                                        "children": [
                                            { "size": 14970, "caption": "mediator_thread_impl.cc 15.0k" },
                                            { "size": 6120, "caption": "listen_task.cc 6.1k" },
                                            { "size": 4990, "caption": "send_update_task.cc 5.0k" },
                                            { "size": 4240, "caption": "subscribe_task.cc 4.2k" },
                                            { "size": 4095, "caption": "talk_mediator_impl.cc 4.1k" },
                                            { "size": 3131, "caption": "xml_element_util.cc 3.1k" }
                                        ]
                                    },
                                    {
                                        "size": 14020,
                                        "caption": "base 14.0k",
                                        "children": [
                                            { "size": 13481, "caption": "chrome_async_socket.cc 13.5k" },
                                            { "size": 412, "caption": "task_pump.cc 412" },
                                            { "size": 127, "caption": "ssl_adapter.cc 127" }
                                        ]
                                    }
                                ]
                            }]
                    ...
                    {
                        "size": 121339,
                        "caption": "/googleurl 121.3k",
                        "children": [{
                                "size": 121339,
                                "caption": "src 121.3k",
                                "children": [
                                    { "size": 19669, "caption": "url_canon_etc.cc 19.7k" },
                                    { "size": 16160, "caption": "url_canon_internal.cc 16.2k" },
                                    { "size": 12741, "caption": "url_canon_mailtourl.cc 12.7k" },
                                    { "size": 12482, "caption": "url_canon_pathurl.cc 12.5k" },
                                    { "size": 12054, "caption": "url_canon_path.cc 12.1k" },
                                    { "size": 9684, "caption": "url_util.cc 9.7k" },
                                    { "size": 8426, "caption": "url_canon_host.cc 8.4k" },
                                    { "size": 7632, "caption": "url_parse.cc 7.6k" },
                                    { "size": 5415, "caption": "url_canon_relative.cc 5.4k" },
                                    { "size": 4152, "caption": "gurl.cc 4.2k" },
                                    { "size": 3741, "caption": "url_canon_ip.cc 3.7k" },
                                    { "size": 2470, "caption": "url_canon_query.cc 2.5k" },
                                    { "size": 2353, "caption": "url_canon_stdurl.cc 2.4k" },
                                    { "size": 1966, "caption": "url_parse_file.cc 2.0k" },
                                    { "size": 1619, "caption": "url_canon_fileurl.cc 1.6k" },
                                    { "size": 775, "caption": "url_canon_icu.cc 775" }
                                ]
                            }]
                    },
                    {
                        "size": 117664,
                        "caption": "/usrinclude 117.7k",
                        "children": [
                            {
                                "size": 107562,
                                "caption": "c++ 107.6k",
                                        ...
                                        "children": [
                                            {
                                                ...
                                                "caption": "bits 104.1k",
                                                "children": [
                                                    { "size": 57842, "caption": "stl_algo.h 57.8k" },
                                                    { "size": 18757, "caption": "stl_heap.h 18.8k" },
                                                    { "size": 9454, "caption": "stl_tree.h 9.5k" },
                                                    { "size": 7633, "caption": "deque.tcc 7.6k" },
                                                    { "size": 6756, "caption": "vector.tcc 6.8k" },
                                                    { "size": 1585, "caption": "basic_string.tcc 1.6k" },
                                                    { "size": 891, "caption": "stl_vector.h 891" },
                                                    { "size": 491, "caption": "stl_map.h 491" },
                                                    { "size": 464, "caption": "basic_string.h 464" },
                                                    { "size": 172, "caption": "stl_function.h 172" },
                                                    { "size": 71, "caption": "stl_deque.h 71" }
                                                ]
                                            },
                                            { "size": 1652, "caption": "sstream 1.7k" },
                                            { "size": 1476, "caption": "ostream 1.5k" }, {
                                                "size": 318,
                                                "caption": "backward 318",
                                                "children": [{ "size": 318, "caption": "hashtable.h 318" }]
                                            }
                                        ]
                                    }]
                            },
                            { "size": 9979, "caption": "stdlib.h 10.0k" }, {
                                "size": 123,
                                "caption": "sys 123",
                                "children": [{ "size": 123, "caption": "epoll.h 123" }]
                            }
                        ]
                    },
                    {
                        ...
                        "children": [
                            {
                                ...
                                "caption": "sql 16.9k",
                                "children": [
                                    { "size": 6768, "caption": "diagnostic_error_delegate.h 6.8k" },
                                    { "size": 5188, "caption": "connection.cc 5.2k" },
                                    { "size": 2776, "caption": "statement.cc 2.8k" },
                                    { "size": 1696, "caption": "meta_table.cc 1.7k" },
                                    { "size": 422, "caption": "transaction.cc 422" }
                                ]
                            },
                            {
                                "size": 15229,
                                ...
                                "children": [
                                    {
                                        ...
                                        "caption": "gl 14.4k",
                                        "children": [
                                            { "size": 7604, "caption": "gl_context_linux.cc 7.6k" },
                                            { "size": 2287, "caption": "gl_context_egl.cc 2.3k" },
                                            { "size": 1803, "caption": "gl_implementation.cc 1.8k" },
                                            { "size": 1283, "caption": "gl_context_osmesa.cc 1.3k" },
                                            { "size": 931, "caption": "gl_implementation_linux.cc 931" },
                                            { "size": 504, "caption": "gl_context.cc 504" },
                                            { "size": 10, "caption": "gl_interface.cc 10" }
                                        ]
                                    },
                                    { "size": 807, "caption": "font_util.cc 807" }
                                ]
                            },
                            { "size": 13277, "caption": "l10n_util.cc 13.3k" },
                            {
                                "size": 10964,
                                "caption": "clipboard 11.0k",
                                "children": [
                                    { "size": 5161, "caption": "clipboard_linux.cc 5.2k" },
                                    { "size": 4626, "caption": "scoped_clipboard_writer.cc 4.6k" },
                                    { "size": 1177, "caption": "clipboard.cc 1.2k" }
                                ]
                            },
                            { "size": 10325, "caption": "text_elider.cc 10.3k" },
                            { "size": 7000, "caption": "x11_util.cc 7.0k" },
                            {
                                "size": 4589,
                                "caption": "menus 4.6k",
                                "children": [
                                    { "size": 3124, "caption": "simple_menu_model.cc 3.1k" },
                                    { "size": 1465, "caption": "button_menu_item_model.cc 1.5k" }
                                ]
                            },
                            { "size": 3447, "caption": "resource_bundle_posix.cc 3.4k" },
                            { "size": 3400, "caption": "resource_bundle.cc 3.4k" },
                            { "size": 3217, "caption": "gtk_dnd_util.cc 3.2k" },
                            { "size": 2696, "caption": "system_monitor.cc 2.7k" },
                            { "size": 2268, "caption": "animation_container.cc 2.3k" },
                            { "size": 1824, "caption": "resource_bundle_linux.cc 1.8k" },
                            {
                                "size": 1726,
                                "caption": "surface 1.7k",
                                "children": [{ "size": 1726, "caption": "transport_dib_linux.cc 1.7k" }]
                            },
                            { "size": 1650, "caption": "active_window_watcher_x.cc 1.6k" },
                            { "size": 1254, "caption": "l10n_util_collator.h 1.3k" },
                            { "size": 1095, "caption": "gtk_util.cc 1.1k" },
                            { "size": 993, "caption": "gtk_signal_registrar.cc 993" },
                            { "size": 948, "caption": "tween.cc 948" },
                            { "size": 747, "caption": "slide_animation.cc 747" },
                            { "size": 738, "caption": "table_model.cc 738" },
                            { "size": 707, "caption": "animation.cc 707" },
                            { "size": 695, "caption": "app_paths.cc 695" },
                            { "size": 639, "caption": "linear_animation.cc 639" },
                            { "size": 342, "caption": "throb_animation.cc 342" },
                            { "size": 61, "caption": "hi_res_timer_manager_posix.cc 61" },
                            { "size": 52, "caption": "theme_provider.cc 52" },
                            { "size": 10, "caption": "l10n_util_posix.cc 10" }
                        ]
                    },
                    {
                        "size": 95235,
                        "caption": "/remoting 95.2k",
                        "children": [
                            {
                                "size": 34702,
                                "caption": "host 34.7k",
                                "children": [
                                    { "size": 10108, "caption": "session_manager.cc 10.1k" },
                                    { "size": 7297, "caption": "client_connection.cc 7.3k" },
                                    { "size": 6504, "caption": "chromoting_host.cc 6.5k" },
                                    { "size": 5851, "caption": "heartbeat_sender.cc 5.9k" },
                                    { "size": 1997, "caption": "host_key_pair.cc 2.0k" },
                                    { "size": 876, "caption": "capturer_fake.cc 876" },
                                    { "size": 807, "caption": "capturer.cc 807" },
                                    { "size": 761, "caption": "json_host_config.cc 761" },
                                    { "size": 444, "caption": "chromoting_host_context.cc 444" },
                                    { "size": 57, "caption": "event_executor_linux.cc 57" }
                                ]
                            },
                            {
                                "size": 21143,
                                "caption": "jingle_glue 21.1k",
                                "children": [
                                    { "size": 9806, "caption": "jingle_client.cc 9.8k" },
                                    { "size": 6006, "caption": "jingle_channel.cc 6.0k" },
                                    { "size": 2435, "caption": "jingle_info_task.cc 2.4k" },
                                    { "size": 1631, "caption": "iq_request.cc 1.6k" },
                                    { "size": 757, "caption": "jingle_thread.cc 757" },
                                    { "size": 508, "caption": "relay_port_allocator.cc 508" }
                                ]
                            },
                            {
                                "size": 20791,
                                "caption": "client 20.8k",
                                "children": [
                                    {
                                        "size": 10851,
                                        "caption": "plugin 10.9k",
                                        "children": [
                                            {
                                                "size": 5803,
                                                "caption": "chromoting_scriptable_object.cc 5.8k"
                                            },
                                            { "size": 2603, "caption": "pepper_view.cc 2.6k" },
                                            { "size": 2067, "caption": "chromoting_instance.cc 2.1k" },
                                            { "size": 188, "caption": "pepper_entrypoints.cc 188" },
                                            { "size": 115, "caption": "pepper_util.cc 115" },
                                            { "size": 75, "caption": "pepper_input_handler.cc 75" }
                                        ]
                                    },
                                    { "size": 4171, "caption": "jingle_host_connection.cc 4.2k" },
                                    { "size": 4011, "caption": "chromoting_client.cc 4.0k" },
                                    { "size": 1434, "caption": "chromoting_view.cc 1.4k" },
                                    { "size": 324, "caption": "client_context.cc 324" }
                                ]
                            },
                            {
                                "size": 18599,
                                "caption": "base 18.6k",
                                "children": [
                                    { "size": 4594, "caption": "decoder_zlib.cc 4.6k" },
                                    { "size": 4353, "caption": "decoder_verbatim.cc 4.4k" },
                                    { "size": 2624, "caption": "encoder_zlib.cc 2.6k" },
                                    { "size": 1940, "caption": "compressor_zlib.cc 1.9k" },
                                    { "size": 1633, "caption": "decompressor_zlib.cc 1.6k" },
                                    { "size": 1566, "caption": "multiple_array_input_stream.cc 1.6k" },
                                    { "size": 1550, "caption": "protocol_decoder.cc 1.6k" },
                                    { "size": 339, "caption": "protocol_util.cc 339" }
                                ]
                            }
                        ]
                    },
                    {
                        ...
                        "caption": "/ipc 83.3k",
                        "children": [
                            { "size": 36794, "caption": "ipc_message_utils.h 36.8k" },
                            { "size": 20402, "caption": "ipc_channel_posix.cc 20.4k" },
                            { "size": 8572, "caption": "ipc_sync_channel.cc 8.6k" },
                            { "size": 3545, "caption": "ipc_channel_proxy.cc 3.5k" },
                            { "size": 3416, "caption": "ipc_message_utils.cc 3.4k" },
                            { "size": 2982, "caption": "file_descriptor_set_posix.cc 3.0k" },
                            { "size": 2718, "caption": "ipc_sync_message.cc 2.7k" },
                            { "size": 2601, "caption": "ipc_message.cc 2.6k" },
                            { "size": 2319, "caption": "ipc_sync_message_filter.cc 2.3k" }
                        ]
                    },
                    { "size": 59077, "caption": "::v8 59.1k" },
                    {
                        "size": 42333,
                        "caption": "/sandbox 42.3k",
                        "children": [{
                                "size": 42333,
                                "caption": "linux 42.3k",
                                "children": [{
                                        "size": 42333,
                                        "caption": "seccomp 42.3k",
                                        "children": [
                                            { "size": 10559, "caption": "library.cc 10.6k" },
                                            { "size": 5342, "caption": "maps.cc 5.3k" },
                                            { "size": 4527, "caption": "sandbox.cc 4.5k" },
                                            { "size": 2876, "caption": "trusted_process.cc 2.9k" },
                                            { "size": 2716, "caption": "socketcall.cc 2.7k" },
                                            { "size": 2207, "caption": "stat.cc 2.2k" },
                                            { "size": 1842, "caption": "trusted_thread.cc 1.8k" },
                                            { "size": 1502, "caption": "open.cc 1.5k" },
                                            { "size": 1279, "caption": "access.cc 1.3k" },
                                            { "size": 1253, "caption": "sigaction.cc 1.3k" },
                                            { "size": 1062, "caption": "x86_decode.cc 1.1k" },
                                            { "size": 901, "caption": "securemem.cc 901" },
                                            { "size": 878, "caption": "ipc.cc 878" },
                                            { "size": 820, "caption": "clone.cc 820" },
                                            { "size": 713, "caption": "mmap.cc 713" },
                                            { "size": 688, "caption": "madvise.cc 688" },
                                            { "size": 671, "caption": "munmap.cc 671" },
                                            { "size": 670, "caption": "mprotect.cc 670" },
                                            { "size": 587, "caption": "ioctl.cc 587" },
                                            { "size": 373, "caption": "syscall.cc 373" },
                                            { "size": 309, "caption": "exit.cc 309" },
                                            { "size": 273, "caption": "sigprocmask.cc 273" },
                                            { "size": 262, "caption": "allocator.cc 262" },
                                            { "size": 13, "caption": "gettid.cc 13" },
                                            { "size": 10, "caption": "getpid.cc 10" }
                                        ]
                                    }]
                            }]
                    },
                    {
                        ...
                        "caption": "/gfx 35.9k",
                        "children": [
                            { "size": 10009, "caption": "skbitmap_operations.cc 10.0k" }, {
                                "size": 6533,
                                "caption": "codec 6.5k",
                                "children": [
                                    { "size": 4902, "caption": "png_codec.cc 4.9k" },
                                    { "size": 1631, "caption": "jpeg_codec.cc 1.6k" }
                                ]
                            },
                            { "size": 4450, "caption": "platform_font_gtk.cc 4.5k" },
                            { "size": 3281, "caption": "canvas_skia.cc 3.3k" },
                            { "size": 2509, "caption": "canvas_skia_linux.cc 2.5k" },
                            { "size": 2281, "caption": "color_utils.cc 2.3k" },
                            { "size": 2221, "caption": "gtk_native_view_id_manager.cc 2.2k" },
                            { "size": 1600, "caption": "rect.cc 1.6k" },
                            { "size": 1253, "caption": "blit.cc 1.3k" },
                            { "size": 610, "caption": "gtk_util.cc 610" },
                            { "size": 497, "caption": "font.cc 497" },
                            { "size": 394, "caption": "size.cc 394" },
                            { "size": 155, "caption": "native_widget_types_gtk.cc 155" },
                            { "size": 113, "caption": "skia_utils_gtk.cc 113" },
                            { "size": 40, "caption": "point.cc 40" }
                        ]
                    },
                    {
                        "size": 23684,
                        ...
                        "children": [{
                                ...
                                "caption": "ext 23.7k",
                                "children": [
                                    { "size": 6101, "caption": "vector_platform_device_linux.cc 6.1k" },
                                    { "size": 5837, "caption": "image_operations.cc 5.8k" },
                                    { "size": 3089, "caption": "SkFontHost_fontconfig_direct.cpp 3.1k" },
                                    { "size": 2369, "caption": "convolver.cc 2.4k" },
                                    { "size": 2024, "caption": "SkFontHost_fontconfig.cpp 2.0k" },
                                    { "size": 1444, "caption": "SkFontHost_fontconfig_ipc.cpp 1.4k" },
                                    { "size": 1091, "caption": "bitmap_platform_device_linux.cc 1.1k" },
                                    { "size": 741, "caption": "platform_canvas_linux.cc 741" },
                                    { "size": 296, "caption": "vector_canvas_linux.cc 296" },
                                    { "size": 220, "caption": "SkMemory_new_handler.cpp 220" },
                                    { "size": 195, "caption": "google_logging.cc 195" },
                                    { "size": 148, "caption": "vector_canvas.cc 148" },
                                    { "size": 92, "caption": "platform_canvas.cc 92" },
                                    { "size": 37, "caption": "platform_device_linux.cc 37" }
                                ]
                            }]
                    },
                    { "size": 20500, "caption": "other unknown 20.5k" },
                    {
                        "size": 20387,
                        "caption": "/sdch 20.4k",
                        "children": [{
                                "size": 20387,
                                "caption": "open-vcdiff 20.4k",
                                "children": [{
                                        "size": 20387,
                                        "caption": "src 20.4k",
                                        "children": [
                                            { "size": 8669, "caption": "vcdecoder.cc 8.7k" },
                                            { "size": 5015, "caption": "headerparser.cc 5.0k" },
                                            { "size": 2706, "caption": "codetable.cc 2.7k" },
                                            { "size": 1817, "caption": "addrcache.cc 1.8k" },
                                            { "size": 930, "caption": "decodetable.cc 930" },
                                            { "size": 866, "caption": "adler32.c 866" },
                                            { "size": 366, "caption": "logging.h 366" },
                                            { "size": 18, "caption": "logging.cc 18" }
                                        ]
                                    }]
                            }]
                    },
                    { "size": 11413, "caption": "::non-virtual thunk to WebCore 11.4k" },
                    {
                        "size": 10409,
                        "caption": "/printing 10.4k",
                        "children": [
                            { "size": 4242, "caption": "pdf_ps_metafile_cairo.cc 4.2k" },
                            { "size": 1617, "caption": "printed_document.cc 1.6k" },
                            { "size": 1542, "caption": "printing_context_cairo.cc 1.5k" },
                            { "size": 914, "caption": "units.cc 914" },
                            { "size": 620, "caption": "page_setup.cc 620" },
                            { "size": 553, "caption": "print_settings.cc 553" },
                            { "size": 549, "caption": "page_number.cc 549" },
                            { "size": 313, "caption": "page_overlays.cc 313" },
                            { "size": 59, "caption": "printed_page.cc 59" }
                        ]
                    },
                    { "size": 7591, "caption": "::global constructors keyed to cricket 7.6k" },
                    { "size": 6487, "caption": "::WebCore 6.5k" },
                    { "size": 3586, "caption": "::global constructors keyed to sync_pb 3.6k" },
                    { "size": 3315, "caption": "::global constructors keyed to v8 3.3k" },
                    {
                        "size": 1989,
                        "caption": "/work 2.0k",
                        "children": [{
                                ...
                                "children": [{
                                        "size": 1989,
                                        "caption": "css 2.0k",
                                        "children": [{ "size": 1989, "caption": "tokenizer.flex 2.0k" }]
                                    }]
                            }]
                    },
                    { "size": 1632, "caption": "::non-virtual thunk to RenderView 1.6k" },
                    {
                        "size": 1377,
                        "caption": "::global constructors keyed to userfeedback 1.4k"
                    },
                    { "size": 1190, "caption": "::non-virtual thunk to TabContents 1.2k" },
                    { "size": 1066, "caption": "::non-virtual thunk to WebKit 1.1k" },
                    { "size": 962, "caption": "::global constructors keyed to google 962" },
                    {
                        "size": 882,
                        "caption": "::global constructors keyed to FLAG__namespace_do_not_use_directly_use_DECLARE_int64_instead 882"
                    },
                    { "size": 791, "caption": "::global constructors keyed to buzz 791" },
                    { "size": 783, "caption": "::net 783" },
                    { "size": 760, "caption": "::global constructors keyed to talk_base 760" },
                    { "size": 755, "caption": "::Perfect_Hash 755" },
                    { "size": 720, "caption": "::non-virtual thunk to Browser 720" },
                    { "size": 627, "caption": "::icu_4_2 627" },
                    {
                        "size": 548,
                        "caption": "::global constructors keyed to RenderProcessHost 548"
                    },
                    {
                        "size": 541,
                        "caption": "::global constructors keyed to IPCWebSocketStreamHandleBridge 541"
                    },
                    { "size": 520, "caption": "::non-virtual thunk to net 520" },
                    { "size": 500, "caption": "::non-virtual thunk to cricket 500" },
                    { "size": 490, "caption": "::non-virtual thunk to media 490" },
                    {
                        "size": 480,
                        "caption": "::non-virtual thunk to (anonymous namespace) 480"
                    },
                    {
                        "size": 479,
                        "caption": "::global constructors keyed to sync_notifier 479"
                    },
                    { "size": 472, "caption": "::global constructors keyed to WebCore 472" },
                    {
                        "size": 464,
                        "caption": "::global constructors keyed to PluginChannelBase 464"
                    },
                    {
                        "size": 464,
                        "caption": "::global constructors keyed to BrowsingInstance 464"
                    },
                    { "size": 460, "caption": "::non-virtual thunk to browser_sync 460" },
                    { "size": 420, "caption": "::non-virtual thunk to webkit_glue 420" },
                    {
                        "size": 405,
                        "caption": "::global constructors keyed to EscapeQueryParamValue(std 405"
                    },
                    { "size": 404, "caption": "::global constructors keyed to net 404" },
                    { "size": 396, "caption": "::virtual thunk to WebCore 396" },
                    { "size": 393, "caption": "::global constructors keyed to invalidation 393" },
                    {
                        "size": 393,
                        "caption": "::global constructors keyed to DebuggerRemoteServiceCommand 393"
                    },
                    { "size": 377, "caption": "::non-virtual thunk to gfx 377" },
                    {
                        "size": 370,
                        "caption": "::non-virtual thunk to WebPluginDelegatePepper 370"
                    },
                    { "size": 365, "caption": "::global constructors keyed to AutoFillType 365" },
                    {
                        "size": 353,
                        "caption": "::global constructors keyed to FLAG__namespace_do_not_use_directly_use_DECLARE_int32_instead 353"
                    },
                    { "size": 336, "caption": "::global constructors keyed to open_vcdiff 336" },
                    { "size": 318, "caption": "::disk_cache 318" },
                    { "size": 310, "caption": "::non-virtual thunk to ExtensionHost 310" },
                    { "size": 310, "caption": "::non-virtual thunk to notifier 310" },
                    { "size": 307, "caption": "::SkPaint 307" },
                    { "size": 305, "caption": "::global constructors keyed to ots 305" },
                    { "size": 300, "caption": "::non-virtual thunk to TabStripGtk 300" },
                    { "size": 290, "caption": "::SkMatrix 290" },
                    { "size": 260, "caption": "::non-virtual thunk to LocationBarViewGtk 260" },
                    { "size": 260, "caption": "::non-virtual thunk to BookmarkBarGtk 260" },
                    { "size": 237, "caption": "::global constructors keyed to base 237" },
                    { "size": 234, "caption": "::virtual thunk to RenderWidget 234" },
                    { "size": 229, "caption": "::non-virtual thunk to appcache 229" },
                    { "size": 225, "caption": "::global constructors keyed to Extension 225" },
                    { "size": 220, "caption": "::non-virtual thunk to WrenchMenuModel 220" },
                    { "size": 202, "caption": "::global constructors keyed to BrowserList 202" },
                    { "size": 200, "caption": "::non-virtual thunk to remoting 200" },
                    { "size": 193, "caption": "::gfx 193" },
                    { "size": 190, "caption": "::non-virtual thunk to talk_base 190" },
                    { "size": 189, "caption": "::buzz 189" },
                    { "size": 187, "caption": "::WebKit 187" },
                    { "size": 180, "caption": "::non-virtual thunk to BrowserToolbarGtk 180" },
                    { "size": 176, "caption": "::google 176" },
                    { "size": 163, "caption": "::gpu 163" },
                    { "size": 160, "caption": "::non-virtual thunk to sync_notifier 160" },
                    { "size": 160, "caption": "::non-virtual thunk to BackgroundContents 160" },
                    { "size": 160, "caption": "::non-virtual thunk to pepper 160" },
                    { "size": 159, "caption": "::SkPath 159" },
                    { "size": 157, "caption": "::global constructors keyed to SpinLock 157" },
                    { "size": 156, "caption": "::BrowserChildProcessHost 156" },
                    { "size": 152, "caption": "::global constructors keyed to WebKit 152" },
                    {
                        "size": 150,
                        "caption": "::non-virtual thunk to WebPluginDelegateProxy 150"
                    },
                    {
                        "size": 144,
                        "caption": "::global constructors keyed to FLAG__namespace_do_not_use_directly_use_DECLARE_bool_instead 144"
                    },
                    { "size": 144, "caption": "::global constructors keyed to playground 144" },
                    { "size": 144, "caption": "::global constructors keyed to appcache 144" },
                    { "size": 140, "caption": "::non-virtual thunk to history 140" },
                    { "size": 140, "caption": "::non-virtual thunk to PluginProcessHost 140" },
                    { "size": 140, "caption": "::non-virtual thunk to ExtensionsDOMHandler 140" },
                    {
                        "size": 140,
                        "caption": "::non-virtual thunk to BrowserOptionsHandler 140"
                    },
                    { "size": 140, "caption": "::non-virtual thunk to printing 140" },
                    {
                        "size": 135,
                        "caption": "::global constructors keyed to FLAG__namespace_do_not_use_directly_use_DECLARE_string_instead 135"
                    },
                    { "size": 134, "caption": "::global constructors keyed to browser 134" },
                    {
                        "size": 130,
                        "caption": "::non-virtual thunk to BrowserActionsToolbarGtk 130"
                    },
                    {
                        "size": 130,
                        "caption": "::non-virtual thunk to DraggedTabControllerGtk 130"
                    },
                    { "size": 128, "caption": "::global constructors keyed to media 128" },
                    {
                        "size": 126,
                        "caption": "::global constructors keyed to CharacterEncoding 126"
                    },
                    { "size": 123, "caption": "::talk_base 123" },
                    { "size": 120, "caption": "::non-virtual thunk to PrinterJobHandler 120" },
                    {
                        "size": 120,
                        "caption": "::non-virtual thunk to NetworkLocationProvider 120"
                    },
                    { "size": 118, "caption": "::SkRegion 118" },
                    {
                        "size": 111,
                        "caption": "::non-virtual thunk to TestingAutomationProvider 111"
                    },
                    { "size": 110, "caption": "::non-virtual thunk to BrowserWindowGtk 110" },
                    { "size": 110, "caption": "::TabStripModel 110" },
                    {
                        "size": 110,
                        "caption": "::non-virtual thunk to BrowserRenderProcessHost 110"
                    },
                    { "size": 108, "caption": "::WTF 108" },
                    { "size": 106, "caption": "::pp 106" },
                    { "size": 102, "caption": "::NavigationController 102" },
                    { "size": 102, "caption": "::history 102" },
                    { "size": 100, "caption": "::non-virtual thunk to AudioRendererImpl 100" },
                    {
                        "size": 100,
                        "caption": "::non-virtual thunk to ExtensionContextMenuModel 100"
                    },
                    { "size": 100, "caption": "::non-virtual thunk to buzz 100" },
                    {
                        "size": 100,
                        "caption": "::non-virtual thunk to BrowserChildProcessHost 100"
                    },
                    { "size": 97, "caption": "::browser_sync 97" },
                    { "size": 94, "caption": "::global constructors keyed to syncable 94" },
                    { "size": 90, "caption": "::non-virtual thunk to InterstitialPage 90" },
                    { "size": 90, "caption": "::non-virtual thunk to IPC 90" },
                    { "size": 90, "caption": "::non-virtual thunk to TranslateInfoBarBase 90" },
                    { "size": 90, "caption": "::non-virtual thunk to BrowserTitlebar 90" },
                    { "size": 90, "caption": "::virtual thunk to RenderView 90" },
                    { "size": 90, "caption": "::non-virtual thunk to icu_4_2 90" },
                    { "size": 90, "caption": "::non-virtual thunk to GeneralPageGtk 90" },
                    { "size": 90, "caption": "::non-virtual thunk to HtmlDialogGtk 90" },
                    { "size": 90, "caption": "::non-virtual thunk to ResourceMessageFilter 90" },
                    { "size": 90, "caption": "::non-virtual thunk to NaClProcessHost 90" },
                    { "size": 88, "caption": "::global constructors keyed to Watchdog 88" },
                    {
                        "size": 86,
                        "caption": "::global constructors keyed to URLFetcherProtectEntry 86"
                    },
                    {
                        "size": 86,
                        "caption": "::global constructors keyed to BrowserWindowGtk 86"
                    },
                    { "size": 86, "caption": "::global constructors keyed to DevToolsAgent 86" },
                    {
                        "size": 85,
                        "caption": "::global constructors keyed to BookmarksFunction 85"
                    },
                    {
                        "size": 83,
                        "caption": "::global constructors keyed to chrome_browser_net_websocket_experiment 83"
                    },
                    { "size": 81, "caption": "::TParseContext 81" },
                    { "size": 80, "caption": "::non-virtual thunk to WebPluginDelegateImpl 80" },
                    { "size": 80, "caption": "::non-virtual thunk to BlockedPluginManager 80" },
                    { "size": 80, "caption": "::non-virtual thunk to ExtensionInfoBarGtk 80" },
                    { "size": 80, "caption": "::non-virtual thunk to ImportDataHandler 80" },
                    {
                        "size": 80,
                        "caption": "::non-virtual thunk to SearchEngineManagerHandler 80"
                    },
                    { "size": 80, "caption": "::non-virtual thunk to BalloonViewImpl 80" },
                    { "size": 80, "caption": "::non-virtual thunk to WorkerProcessHost 80" },
                    { "size": 80, "caption": "::non-virtual thunk to WorkerWebKitClientImpl 80" },
                    { "size": 80, "caption": "::non-virtual thunk to GpuVideoDecoder 80" },
                    { "size": 80, "caption": "::non-virtual thunk to speech_input 80" },
                    { "size": 80, "caption": "::non-virtual thunk to AddStartupPageHandler 80" },
                    { "size": 80, "caption": "::non-virtual thunk to GpuProcessHost 80" },
                    { "size": 76, "caption": "::global constructors keyed to remoting 76" },
                    { "size": 72, "caption": "::DevToolsManager 72" },
                    { "size": 72, "caption": "::non-virtual thunk to TabGtk 72" },
                    { "size": 70, "caption": "::non-virtual thunk to RenderThread 70" },
                    { "size": 70, "caption": "::non-virtual thunk to NPAPI 70" },
                    { "size": 70, "caption": "::non-virtual thunk to DevToolsWindow 70" },
                    { "size": 70, "caption": "::non-virtual thunk to StatusBubbleGtk 70" },
                    { "size": 70, "caption": "::non-virtual thunk to DragDownloadFile 70" },
                    { "size": 70, "caption": "::non-virtual thunk to FindBarGtk 70" },
                    { "size": 70, "caption": "::non-virtual thunk to UtilityProcessHost 70" },
                    {
                        "size": 70,
                        "caption": "::non-virtual thunk to SafeBrowsingResourceHandler 70"
                    },
                    {
                        "size": 70,
                        "caption": "::non-virtual thunk to TabContentsFileSelectHelper 70"
                    },
                    {
                        "size": 70,
                        "caption": "::non-virtual thunk to chrome_browser_net_websocket_experiment 70"
                    },
                    { "size": 70, "caption": "::non-virtual thunk to CommandBufferProxy 70" },
                    { "size": 68, "caption": "::remoting 68" },
                    {
                        "size": 68,
                        "caption": "::global constructors keyed to FLAG__namespace_do_not_use_directly_use_DECLARE_double_instead 68"
                    },
                    {
                        "size": 68,
                        "caption": "::global constructors keyed to Gradient_Shader 68"
                    },
                    { "size": 66, "caption": "::global constructors keyed to SkGlyphCache 66" },
                    {
                        "size": 66,
                        "caption": "::global constructors keyed to BrowserURLHandler 66"
                    },
                    { "size": 66, "caption": "::base 66" },
                    {
                        "size": 66,
                        "caption": "::global constructors keyed to URLRequestSlowDownloadJob 66"
                    },
                    {
                        "size": 65,
                        "caption": "::global constructors keyed to chrome_browser_net 65"
                    },
                    { "size": 65, "caption": "::global constructors keyed to FindBarGtk 65" },
                    { "size": 65, "caption": "::WebPluginDelegatePepper 65" },
                    { "size": 64, "caption": "::AutomationResourceTrackerImpl 64" },
                    { "size": 64, "caption": "::global constructors keyed to DebugUtil 64" },
                    {
                        "size": 63,
                        "caption": "::global constructors keyed to ExtensionPortsRemoteService 63"
                    },
                    { "size": 63, "caption": "::global constructors keyed to BugReportUtil 63" },
                    { "size": 63, "caption": "::global constructors keyed to Browser 63" },
                    { "size": 62, "caption": "::global constructors keyed to IPC 62" },
                    { "size": 60, "caption": "::non-virtual thunk to plugin 60" },
                    { "size": 60, "caption": "::non-virtual thunk to ProfileSyncService 60" },
                    { "size": 60, "caption": "::non-virtual thunk to AlternateNavURLFetcher 60" },
                    { "size": 60, "caption": "::non-virtual thunk to DownloadShelfGtk 60" },
                    {
                        "size": 60,
                        "caption": "::non-virtual thunk to NotificationOptionsMenuModel 60"
                    },
                    { "size": 60, "caption": "::non-virtual thunk to GoogleURLTracker 60" },
                    {
                        "size": 60,
                        "caption": "::non-virtual thunk to TranslateMessageInfoBar 60"
                    },
                    { "size": 60, "caption": "::non-virtual thunk to AdvancedOptionsHandler 60" },
                    {
                        "size": 60,
                        "caption": "::non-virtual thunk to IntranetRedirectDetector 60"
                    },
                    { "size": 60, "caption": "::non-virtual thunk to DownloadItemGtk 60" },
                    { "size": 60, "caption": "::non-virtual thunk to ProfileImpl 60" },
                    { "size": 60, "caption": "::non-virtual thunk to OptionsMenuModel 60" },
                    { "size": 60, "caption": "::non-virtual thunk to AutoFillOptionsHandler 60" },
                    { "size": 60, "caption": "::non-virtual thunk to RemotingSetupFlow 60" },
                    { "size": 60, "caption": "::non-virtual thunk to BeforeTranslateInfoBar 60" },
                    { "size": 60, "caption": "::non-virtual thunk to AfterTranslateInfoBar 60" },
                    { "size": 60, "caption": "::non-virtual thunk to DownloadsDOMHandler 60" },
                    { "size": 60, "caption": "::non-virtual thunk to KeywordEditorView 60" },
                    { "size": 60, "caption": "::non-virtual thunk to BackgroundModeManager 60" },
                    { "size": 60, "caption": "::non-virtual thunk to ExtensionPopupGtk 60" },
                    { "size": 60, "caption": "::non-virtual thunk to CookiesViewHandler 60" },
                    { "size": 60, "caption": "::open_vcdiff 60" },
                    {
                        "size": 59,
                        "caption": "::global constructors keyed to AutocompleteHistoryManager 59"
                    },
                    { "size": 59, "caption": "::global constructors keyed to ContactInfo 59" },
                    { "size": 58, "caption": "::global constructors keyed to ggl 58" },
                    { "size": 58, "caption": "::AutocompleteEditModel 58" },
                    { "size": 57, "caption": "::FilePath 57" },
                    { "size": 56, "caption": "::global constructors keyed to SkFaceRec 56" },
                    { "size": 56, "caption": "::global constructors keyed to SkPixelRef 56" },
                    { "size": 56, "caption": "::global constructors keyed to SkGlobals 56" },
                    {
                        "size": 55,
                        "caption": "::global constructors keyed to ExtensionProcessBindings 55"
                    },
                    { "size": 55, "caption": "::StatsTable 55" },
                    { "size": 54, "caption": "::URLRequestJob 54" },
                    { "size": 54, "caption": "::WorkerProcessHost 54" },
                    { "size": 54, "caption": "::SkGlyph 54" },
                    { "size": 53, "caption": "::RenderWidget 53" },
                    { "size": 52, "caption": "::non-virtual thunk to URLRequestFileDirJob 52" },
                    { "size": 51, "caption": "::global constructors keyed to NPAPI 51" },
                    { "size": 50, "caption": "::cricket 50" },
                    { "size": 50, "caption": "::non-virtual thunk to NPObjectProxy 50" },
                    { "size": 50, "caption": "::non-virtual thunk to BookmarkModel 50" },
                    { "size": 50, "caption": "::non-virtual thunk to MetricsService 50" },
                    {
                        "size": 50,
                        "caption": "::non-virtual thunk to ExtensionBrowserEventRouter 50"
                    },
                    {
                        "size": 50,
                        "caption": "::non-virtual thunk to DownloadThrottlingResourceHandler 50"
                    },
                    { "size": 50, "caption": "::non-virtual thunk to BackingStoreProxy 50" },
                    { "size": 50, "caption": "::non-virtual thunk to HttpListenSocket 50" },
                    { "size": 50, "caption": "::non-virtual thunk to VideoLayerProxy 50" },
                    { "size": 50, "caption": "::non-virtual thunk to sync_api 50" },
                    { "size": 50, "caption": "::non-virtual thunk to CloudPrintProxyBackend 50" },
                    {
                        "size": 50,
                        "caption": "::non-virtual thunk to ClearBrowserDataHandler 50"
                    },
                    { "size": 50, "caption": "::non-virtual thunk to ServiceProcessControl 50" },
                    { "size": 50, "caption": "::non-virtual thunk to AutoFillManager 50" },
                    {
                        "size": 50,
                        "caption": "::non-virtual thunk to DevToolsRemoteListenSocket 50"
                    },
                    { "size": 50, "caption": "::non-virtual thunk to ChromeAppCacheService 50" },
                    { "size": 50, "caption": "::non-virtual thunk to CollectedCookiesGtk 50" },
                    {
                        "size": 50,
                        "caption": "::non-virtual thunk to BookmarkContextMenuController 50"
                    },
                    { "size": 50, "caption": "::non-virtual thunk to NPObjectStub 50" },
                    { "size": 49, "caption": "::printing 49" },
                    { "size": 48, "caption": "::global constructors keyed to CpuProfiler 48" },
                    { "size": 48, "caption": "::global constructors keyed to ChromeThread 48" },
                    {
                        "size": 48,
                        "caption": "::global constructors keyed to URLRequestSlowHTTPJob 48"
                    },
                    { "size": 48, "caption": "::global constructors keyed to plugin 48" },
                    {
                        "size": 48,
                        "caption": "::global constructors keyed to URLRequestMockHTTPJob 48"
                    },
                    { "size": 48, "caption": "::ContentSettingComboModel 48" },
                    { "size": 47, "caption": "::TabStripGtk 47" },
                    { "size": 46, "caption": "::global constructors keyed to MetricsLogBase 46" },
                    { "size": 46, "caption": "::EncodingMenuController 46" },
                    { "size": 46, "caption": "::global constructors keyed to google_update 46" },
                    { "size": 45, "caption": "::RenderThread 45" },
                    {
                        "size": 42,
                        "caption": "::global constructors keyed to mozilla_security_manager 42"
                    },
                    { "size": 42, "caption": "::ExtensionTabUtil 42" },
                    { "size": 42, "caption": "::CustomDrawButtonBase 42" },
                    { "size": 40, "caption": "::non-virtual thunk to WebViewPlugin 40" },
                    { "size": 40, "caption": "::non-virtual thunk to Toolbar5Importer 40" },
                    { "size": 40, "caption": "::non-virtual thunk to WifiDataProviderCommon 40" },
                    { "size": 40, "caption": "::non-virtual thunk to CrxInstaller 40" },
                    {
                        "size": 40,
                        "caption": "::non-virtual thunk to BookmarkFolderEditorController 40"
                    },
                    { "size": 40, "caption": "::global constructors keyed to nacl 40" },
                    { "size": 40, "caption": "::non-virtual thunk to PushSource 40" },
                    { "size": 40, "caption": "::non-virtual thunk to SavePackage 40" },
                    { "size": 40, "caption": "::non-virtual thunk to BookmarkMenuController 40" },
                    { "size": 40, "caption": "::non-virtual thunk to LanguagesPageGtk 40" },
                    {
                        "size": 40,
                        "caption": "::non-virtual thunk to DevToolsHttpProtocolHandler 40"
                    },
                    { "size": 40, "caption": "::SkDevice 40" },
                    { "size": 40, "caption": "::non-virtual thunk to EncodingMenuModel 40" },
                    {
                        "size": 40,
                        "caption": "::non-virtual thunk to ServiceGaiaAuthenticator 40"
                    },
                    { "size": 39, "caption": "::non-virtual thunk to URLRequestInterceptJob 39" },
                    { "size": 39, "caption": "::RenderView 39" },
                    { "size": 39, "caption": "::SkCanvas 39" },
                    {
                        "size": 39,
                        "caption": "::non-virtual thunk to RenderViewContextMenuGtk 39"
                    },
                    { "size": 37, "caption": "::global constructors keyed to gfx 37" },
                    { "size": 36, "caption": "::virtual thunk to WebViewPlugin 36" },
                    { "size": 36, "caption": "::plugin 36" },
                    { "size": 35, "caption": "::InfoBarDelegate 35" },
                    { "size": 34, "caption": "::ExtensionMenuItem 34" },
                    { "size": 34, "caption": "::DownloadHistory 34" },
                    { "size": 33, "caption": "::hunspell 33" },
                    { "size": 32, "caption": "::TranslateInfoBarDelegate 32" },
                    { "size": 31, "caption": "::AffixMgr 31" },
                    { "size": 30, "caption": "::non-virtual thunk to BookmarkStorage 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to TaskManagerTabContentsResourceProvider 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to TabContentsViewGtk 30" },
                    { "size": 30, "caption": "::non-virtual thunk to CrashHandlerHostLinux 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to GeolocationArbitratorImpl 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to NewTabPageSyncHandler 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to TabContentsContainerGtk 30"
                    },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to AutocompletePopupViewGtk 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to GpuChannel 30" },
                    { "size": 30, "caption": "::non-virtual thunk to BrowsingHistoryHandler 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to ContentSettingBubbleGtk 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to ServiceIPCServer 30" },
                    { "size": 30, "caption": "::non-virtual thunk to HistoryService 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ExtensionDOMUI 30" },
                    { "size": 30, "caption": "::non-virtual thunk to CoreOptionsHandler 30" },
                    { "size": 30, "caption": "::non-virtual thunk to PepperScrollbarWidget 30" },
                    { "size": 30, "caption": "::non-virtual thunk to TabRendererGtk 30" },
                    { "size": 30, "caption": "::non-virtual thunk to LoginHandler 30" },
                    { "size": 30, "caption": "::non-virtual thunk to CommandBufferStub 30" },
                    { "size": 30, "caption": "::non-virtual thunk to BookmarkBubbleGtk 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to ChromeURLRequestContextGetter 30"
                    },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to ModalHtmlDialogDelegate 30"
                    },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to AutocompleteHistoryManager 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to GpuChannelHost 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to DevToolsProtocolHandler 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to ProfileManager 30" },
                    { "size": 30, "caption": "::non-virtual thunk to SessionService 30" },
                    { "size": 30, "caption": "::non-virtual thunk to WebPluginDelegateStub 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to BackgroundContentsService 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to JsonPrefStore 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to TaskManagerExtensionProcessResourceProvider 30"
                    },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to ExtensionInfoBarDelegate 30"
                    },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to AutomationResourceMessageFilter 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to ContentPageGtk 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to BrowsingHistoryHandler2 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to AutomationProvider 30" },
                    { "size": 30, "caption": "::non-virtual thunk to BalloonHost 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ShownSectionsHandler 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ChildThread 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to ContentExceptionsWindowGtk 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to InfoBar 30" },
                    { "size": 30, "caption": "::non-virtual thunk to PluginChannel 30" },
                    { "size": 30, "caption": "::non-virtual thunk to BalloonCollectionImpl 30" },
                    { "size": 30, "caption": "::non-virtual thunk to PasswordStoreDefault 30" },
                    { "size": 30, "caption": "::non-virtual thunk to TranslateManager 30" },
                    { "size": 30, "caption": "::non-virtual thunk to TemplateURLTableModel 30" },
                    { "size": 30, "caption": "::non-virtual thunk to base 30" },
                    { "size": 30, "caption": "::non-virtual thunk to SidebarManager 30" },
                    { "size": 30, "caption": "::non-virtual thunk to PluginService 30" },
                    { "size": 30, "caption": "::non-virtual thunk to PersonalDataManager 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to ExtensionPortsRemoteService 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to BlockedPlugin 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ExtensionPrefStore 30" },
                    { "size": 30, "caption": "::non-virtual thunk to TokenService 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to ThemeInstalledInfoBarDelegate 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to RenderWidgetHost 30" },
                    { "size": 30, "caption": "::non-virtual thunk to FontSettingsHandler 30" },
                    { "size": 30, "caption": "::non-virtual thunk to NewTabUI 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ThumbnailGenerator 30" },
                    { "size": 30, "caption": "::non-virtual thunk to GpuProcessHostUIShim 30" },
                    { "size": 30, "caption": "::non-virtual thunk to AppLauncherHandler 30" },
                    { "size": 30, "caption": "::non-virtual thunk to GtkThemeProvider 30" },
                    { "size": 30, "caption": "::non-virtual thunk to AudioDeviceContext 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ExtensionsService 30" },
                    { "size": 30, "caption": "::non-virtual thunk to TemplateURLModel 30" },
                    { "size": 30, "caption": "::non-virtual thunk to GpuCommandBufferStub 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ContentSettingsHandler 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to JavaScriptAppModalDialog 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to RenderWidget 30" },
                    { "size": 30, "caption": "::non-virtual thunk to ImporterHost 30" },
                    { "size": 30, "caption": "::non-virtual thunk to PluginChannelBase 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to AutocompleteEditViewGtk 30"
                    },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to TaskManagerNotificationResourceProvider 30"
                    },
                    { "size": 30, "caption": "::non-virtual thunk to invalidation 30" },
                    { "size": 30, "caption": "::non-virtual thunk to WebWorkerProxy 30" },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to WebMessagePortChannelImpl 30"
                    },
                    {
                        "size": 30,
                        "caption": "::non-virtual thunk to TaskManagerChildProcessResourceProvider 30"
                    },
                    { "size": 29, "caption": "::IPC 29" },
                    { "size": 29, "caption": "::TabStripModelOrderController 29" },
                    { "size": 28, "caption": "::global constructors keyed to SkShape 28" },
                    { "size": 28, "caption": "::global constructors keyed to tcmalloc 28" },
                    { "size": 28, "caption": "::Histogram 28" },
                    {
                        "size": 28,
                        "caption": "::global constructors keyed to SkBitmapProcShader 28"
                    },
                    {
                        "size": 28,
                        "caption": "::global constructors keyed to SkBlurDrawLooper 28"
                    },
                    {
                        "size": 28,
                        "caption": "::global constructors keyed to SkBlurMaskFilter 28"
                    },
                    { "size": 28, "caption": "::global constructors keyed to SkBitmap 28" },
                    { "size": 27, "caption": "::SkProcXfermode 27" },
                    { "size": 27, "caption": "::SafeBrowsingService 27" },
                    { "size": 26, "caption": "::non-virtual thunk to BookmarksIOFunction 26" },
                    {
                        "size": 25,
                        "caption": "::global constructors keyed to browser_shutdown 25"
                    },
                    { "size": 25, "caption": "::global constructors keyed to ThumbnailScore 25" },
                    { "size": 25, "caption": "::BrowserThemeProvider 25" },
                    { "size": 25, "caption": "::global constructors keyed to NaCl 25" },
                    { "size": 25, "caption": "::WebWorkerBase 25" },
                    { "size": 24, "caption": "::SkBitmap 24" },
                    { "size": 23, "caption": "::global constructors keyed to browser_sync 23" },
                    { "size": 23, "caption": "::NPObjectProxy 23" },
                    { "size": 22, "caption": "::pepper 22" },
                    { "size": 22, "caption": "::UserScriptIdleScheduler 22" },
                    { "size": 22, "caption": "::ChildThread 22" },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to BrowserMainParts 21"
                    },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to ResourceDispatcherHost 21"
                    },
                    { "size": 21, "caption": "::ChildProcessInfo 21" },
                    { "size": 21, "caption": "::CPBrowsingContextManager 21" },
                    { "size": 21, "caption": "::global constructors keyed to ProfileHandler 21" },
                    { "size": 21, "caption": "::ExtensionProcessManager 21" },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to VisitedLinkMaster 21"
                    },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to SocketStreamDispatcherHost 21"
                    },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to GpuBackingStoreGLXContext 21"
                    },
                    { "size": 21, "caption": "::WebGLES2ContextImpl 21" },
                    { "size": 21, "caption": "::global constructors keyed to NSSDecryptor 21" },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to SocketStreamHost 21"
                    },
                    { "size": 21, "caption": "::webkit_glue 21" },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to Firefox3Importer 21"
                    },
                    { "size": 21, "caption": "::AutoFillHelper 21" },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to SafeBrowsingStoreFile 21"
                    },
                    { "size": 21, "caption": "::RenderWidgetHelper 21" },
                    {
                        "size": 21,
                        "caption": "::global constructors keyed to AlsaPcmOutputStream 21"
                    },
                    { "size": 20, "caption": "::non-virtual thunk to OptionsPageUIHandler 20" },
                    { "size": 20, "caption": "::non-virtual thunk to WorkerThread 20" },
                    { "size": 20, "caption": "::non-virtual thunk to IconManager 20" },
                    { "size": 20, "caption": "::non-virtual thunk to SyncOptionsHandler 20" },
                    { "size": 20, "caption": "::non-virtual thunk to PluginChannelHost 20" },
                    { "size": 20, "caption": "::non-virtual thunk to NaClThread 20" },
                    { "size": 20, "caption": "::non-virtual thunk to StopSyncingHandler 20" },
                    { "size": 20, "caption": "::non-virtual thunk to RenderProcessHost 20" },
                    { "size": 20, "caption": "::GpuVideoService 20" },
                    { "size": 20, "caption": "::non-virtual thunk to PasswordStoreX 20" },
                    {
                        "size": 20,
                        "caption": "::non-virtual thunk to AutoFillEditAddressHandler 20"
                    },
                    {
                        "size": 20,
                        "caption": "::non-virtual thunk to PasswordsRemoveAllHandler 20"
                    },
                    { "size": 20, "caption": "::menus 20" },
                    { "size": 20, "caption": "::non-virtual thunk to LanguageComboboxModel 20" },
                    { "size": 20, "caption": "::non-virtual thunk to PersonalOptionsHandler 20" },
                    {
                        "size": 20,
                        "caption": "::non-virtual thunk to AutoFillEditCreditCardHandler 20"
                    },
                    {
                        "size": 20,
                        "caption": "::non-virtual thunk to PasswordsExceptionsHandler 20"
                    },
                    { "size": 20, "caption": "::non-virtual thunk to WifiDataProviderLinux 20" },
                    { "size": 20, "caption": "::non-virtual thunk to URLFetcher 20" },
                    {
                        "size": 20,
                        "caption": "::non-virtual thunk to SafeBrowsingBlockingPage 20"
                    },
                    { "size": 20, "caption": "::non-virtual thunk to GpuThread 20" },
                    { "size": 20, "caption": "::non-virtual thunk to PluginThread 20" },
                    { "size": 20, "caption": "::non-virtual thunk to UtilityThread 20" },
                    { "size": 20, "caption": "::non-virtual thunk to SSLBlockingPage 20" },
                    { "size": 20, "caption": "::non-virtual thunk to IPCVideoRenderer 20" },
                    {
                        "size": 20,
                        "caption": "::non-virtual thunk to AutomationExtensionTracker 20"
                    },
                    { "size": 20, "caption": "::non-virtual thunk to RenderViewHost 20" },
                    { "size": 20, "caption": "::non-virtual thunk to ResourceDispatcherHost 20" },
                    { "size": 19, "caption": "::AutoFillType 19" },
                    {
                        "size": 19,
                        "caption": "::global constructors keyed to MemoryRegionMap 19"
                    },
                    { "size": 19, "caption": "::TemplateURLTableModel 19" },
                    { "size": 18, "caption": "::virtual thunk to RenderWidgetFullscreen 18" },
                    { "size": 18, "caption": "::global constructors keyed to TabRendererGtk 18" },
                    { "size": 18, "caption": "::AutoFillField 18" },
                    { "size": 17, "caption": "::GpuProcessHostUIShim 17" },
                    { "size": 17, "caption": "::TabContents 17" },
                    { "size": 17, "caption": "::DraggedTabControllerGtk 17" },
                    { "size": 16, "caption": "::ImporterList 16" },
                    { "size": 16, "caption": "::ImportantFileWriter 16" },
                    { "size": 16, "caption": "::FirefoxProfileLock 16" },
                    { "size": 15, "caption": "::global constructors keyed to spdy 15" },
                    { "size": 15, "caption": "::global constructors keyed to Pickle 15" },
                    { "size": 15, "caption": "::BrowserList 15" },
                    {
                        "size": 15,
                        "caption": "::global constructors keyed to RendererExtensionBindings 15"
                    },
                    {
                        "size": 15,
                        "caption": "::global constructors keyed to NavigationController 15"
                    },
                    { "size": 14, "caption": "::TaskManagerExtensionProcessResource 14" },
                    { "size": 14, "caption": "::ExtensionHost 14" },
                    { "size": 14, "caption": "::BalloonViewHost 14" },
                    { "size": 14, "caption": "::KeywordEditorController 14" },
                    { "size": 14, "caption": "::ExtensionViewGtk 14" },
                    { "size": 14, "caption": "::DownloadItemGtk 14" },
                    {
                        "size": 13,
                        "caption": "::non-virtual thunk to ExportBookmarksFunction 13"
                    },
                    {
                        "size": 13,
                        "caption": "::non-virtual thunk to ImportBookmarksFunction 13"
                    },
                    { "size": 12, "caption": "::AutocompleteProvider 12" },
                    { "size": 12, "caption": "::GtkThemeProvider 12" },
                    { "size": 12, "caption": "::ResourceDispatcherHost 12" },
                    { "size": 12, "caption": "::SessionService 12" },
                    { "size": 11, "caption": "::TranslateInfoBarBase 11" },
                    { "size": 11, "caption": "::sync_api 11" },
                    { "size": 10, "caption": "::non-virtual thunk to BookmarksFunction 10" },
                    {
                        "size": 10,
                        "caption": "::non-virtual thunk to ExecuteCodeInTabFunction 10"
                    },
                    { "size": 10, "caption": "::non-virtual thunk to MostVisitedHandler 10" },
                    { "size": 10, "caption": "::non-virtual thunk to WebSharedWorkerProxy 10" },
                    { "size": 10, "caption": "::non-virtual thunk to UserScriptListener 10" },
                    { "size": 10, "caption": "::non-virtual thunk to MessageRouter 10" },
                    { "size": 10, "caption": "::non-virtual thunk to KeywordProvider 10" },
                    {
                        "size": 10,
                        "caption": "::non-virtual thunk to ConfigurationPolicyPrefStore 10"
                    },
                    {
                        "size": 10,
                        "caption": "::non-virtual thunk to DetectTabLanguageFunction 10"
                    },
                    { "size": 10, "caption": "::non-virtual thunk to SearchProvider 10" },
                    { "size": 10, "caption": "::non-virtual thunk to PopupShowFunction 10" },
                    {
                        "size": 10,
                        "caption": "::non-virtual thunk to SSLConfigServiceManagerPref 10"
                    },
                    { "size": 10, "caption": "::ExtensionFunctionDispatcher 10" },
                    { "size": 10, "caption": "::non-virtual thunk to SdchDictionaryFetcher 10" },
                    { "size": 10, "caption": "::TabRendererGtk 10" },
                    {
                        "size": 10,
                        "caption": "::non-virtual thunk to CaptureVisibleTabFunction 10"
                    },
                    { "size": 10, "caption": "::non-virtual thunk to FirstRunBubble 10" },
                    { "size": 10, "caption": "::SdchManager 10" },
                    {
                        "size": 10,
                        "caption": "::non-virtual thunk to ExtensionInstalledBubbleGtk 10"
                    },
                    { "size": 7, "caption": "::TabMenuModel 7" },
                    { "size": 5, "caption": "::global constructors keyed to LowLevelAlloc 5" },
                    { "size": 5, "caption": "::chrome_browser_net 5" },
                    { "size": 5, "caption": "::global constructors keyed to WorkerPool 5" },
                    { "size": 5, "caption": "::global constructors keyed to ResourcesUtil 5" },
                    { "size": 5, "caption": "::global constructors keyed to RenderThread 5" },
                    { "size": 5, "caption": "::global constructors keyed to MessageLoop 5" },
                    { "size": 5, "caption": "::global constructors keyed to PluginThread 5" },
                    {
                        "size": 5,
                        "caption": "::global constructors keyed to AutomationResourceMessageFilter 5"
                    },
                    {
                        "size": 5,
                        "caption": "::global constructors keyed to DeviceDataProvider<WifiData> 5"
                    },
                    { "size": 5, "caption": "::global constructors keyed to TranslateManager 5" },
                    {
                        "size": 5,
                        "caption": "::global constructors keyed to NotificationService 5"
                    },
                    { "size": 5, "caption": "::global constructors keyed to WorkerThread 5" },
                    {
                        "size": 5,
                        "caption": "::global constructors keyed to ExtensionMessageService 5"
                    },
                    { "size": 5, "caption": "::global constructors keyed to printing 5" },
                    { "size": 5, "caption": "::global constructors keyed to ResourceBundle 5" }
                ]
            });
        }
    }
});
System.register("demo", ["treemap", "demo-data"], function(exports_3, context_3) {
    "use strict";
    var __moduleName = context_3 && context_3.id;
    var treemap, demo_data_1;
    var tm, controls;
    function hover(e) {
        var breadcrumbsDiv = document.getElementById('breadcrumbs');
        breadcrumbsDiv.innerText = tm.getAddress(this).map(function (d) { return d.caption; }).join(' > ');
        e.stopPropagation();
    }
    function update() {
        var captions = document.getElementById('captions').checked;
        var dom = document.getElementById('tree');
        dom.innerHTML = '';
        var options = captions ? treemap.newCaptionOptions() : treemap.newOptions();
        var createNode = options.createNode;
        options.createNode = function (data) {
            var dom = createNode(data);
        ...
        tm = new treemap.TreeMap(demo_data_1["default"], options);
        tm.render(dom);
    }
    return {
        setters:[
            ...
            function (demo_data_1_1) {
                demo_data_1 = demo_data_1_1;
            }],
        execute: function() {
